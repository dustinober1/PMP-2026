# Chapter 4 – Ways of Working and Tailoring for Context
...
Use this chapter as your mental "toolbelt" for ways of working. Chapter 3 focused on value; Chapter 4 is about choosing how you will organize the work so that value can actually be delivered.
...
## 4.8 Knowledge Check – Chapter 4

Try these questions to reinforce your understanding.

### 4.8.1 Multiple-Choice Questions

1. A project involves implementing a safety-critical control system in a chemical plant. Requirements are stable and heavily regulated. Which approach is most appropriate?

   A. Pure agile with minimal documentation  
   B. Predictive with detailed upfront design and formal change control  
   C. Hybrid with agile sprints for all safety functions and no predictive elements  
   D. No structured approach; rely on expert judgment alone  

2. A product team is developing a new mobile app in a fast-changing market. Requirements are expected to evolve based on user feedback. Which practice best supports value delivery in this context?

   A. Freezing scope at the start and enforcing strict change control  
   B. Prioritizing the product backlog based on business value and learning, and delivering in short iterations  
   C. Creating a detailed 12-month Gantt chart and avoiding replanning  
   D. Waiting until the end of the project to seek user feedback

3. A large program has a fixed regulatory deadline for compliance but also includes customer-facing features that may change based on feedback. Which approach is most appropriate?

   A. Pure predictive for the entire program  
   B. Pure agile for the entire program  
   C. Hybrid: predictive planning for regulatory milestones, agile delivery for evolving features  
   D. Ad hoc: let each team choose any approach without coordination  

4. During an agile project, the sponsor requests a new feature that would significantly reduce risk for key customers but would require dropping some lower-value items from the near-term backlog. What is the most appropriate response?

   A. Reject the request because the backlog was already agreed  
   B. Add the feature without changing the backlog or timelines  
   C. Work with the product owner to reprioritize the backlog, considering the new feature’s value and impact  
   D. Ask the team to work overtime to add the feature without any trade-offs  

5. A project manager is working in a predictive environment but notices that one part of the project involves exploratory data analysis with uncertain requirements. What tailoring decision would best support value delivery?

   A. Force the exploratory work into a detailed predictive plan with fixed scope  
   B. Cancel the exploratory work because it does not fit the predictive model  
   C. Use agile-like iterations for the exploratory component while keeping the rest of the project under predictive control  
   D. Allow the exploratory team to work with no plan, communication, or oversight  

### 4.8.2 Scenario-Based Questions

6. Your organization is rolling out a new HR system across multiple countries. Core system configuration is relatively standard, but local regulations and culture require adaptation in each country. Which approach is most appropriate?

   A. Single global predictive plan with identical rollout and no local tailoring  
   B. Pure agile with no overall roadmap, leaving each country to self-organize  
   C. Hybrid: predictive program roadmap with country-specific agile iterations for local adaptation  
   D. No formal method; let local IT teams decide independently  

7. A stakeholder in a predictive project asks to add a feature that is not in the original scope. The feature is low-value but politically important to the stakeholder. Approving it will delay delivery and increase cost. What is the most appropriate action?

   A. Approve the change immediately to keep the stakeholder happy  
   B. Reject the change without explanation  
   C. Use the change control process to analyze the impact and discuss with the sponsor, emphasizing the effect on value and commitments  
   D. Implement the change quietly without updating plans or informing others  

---

## 4.9 Answer Key – Chapter 4 Knowledge Check
...
## 4.10 Explanations – Chapter 4 Knowledge Check

1. B – Safety-critical, heavily regulated work  
   - A predictive approach with detailed upfront design and formal change control is appropriate when safety and compliance are paramount and requirements are stable.

2. B – Agile value delivery  
   - In a fast-changing market with evolving requirements, prioritizing a product backlog by value and delivering in iterations allows you to learn and adapt quickly.

3. C – Hybrid for mixed stability  
   - Regulatory deadlines benefit from predictive planning, while evolving customer features are best served with agile delivery. Hybrid intentionally combines both.

4. C – Reprioritize based on value  
   - In agile, the product owner adjusts the backlog to reflect changing value and risk. Adding a high-value risk-reduction feature usually requires trade-offs, not overtime or scope inflation.

5. C – Tailored hybrid within a project  
   - Using agile-like iterations for uncertain, exploratory work while keeping the rest of the project predictable is a classic tailoring decision that supports value delivery.

6. C – Hybrid rollout with local adaptation  
   - A predictive program roadmap for overall rollout, combined with agile iterations for local configuration and feedback, balances global consistency and local needs.

7. C – Change control and value  
   - In a predictive project, changes should go through formal change control. Analyzing impact and discussing with the sponsor ensures that decisions consider value, commitments, and stakeholder relationships.

---

In the next chapter, we will build on these ideas by diving into stakeholders and communication: how to understand who cares about what, and how to align them around value and ways of working in real projects and on the exam.