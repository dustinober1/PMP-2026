...
<div class="theory-grid">
  <div class="theory-card herzberg">
    <div class="theory-title">Herzberg's Two-Factor Theory</div>
    <div class="theory-content">
      <p><strong>Hygiene Factors</strong> (Pay, Working Conditions, Safety, Job Security): Their absence causes dissatisfaction, but their presence does NOT motivate. They are the baseline.</p>
      <p><strong>Motivators</strong> (Growth, Recognition, Responsibility, Achievement): The fuel for high performance. Address these after hygiene factors are met.</p>
    </div>
  </div>
  <div class="theory-card nacc">
    <div class="theory-title">McClelland's Acquired Needs</div>
    <div class="theory-content">
      <p>People are driven by one dominant need:</p>
      <ul>
        <li><strong>Achievement (nAch)</strong>: Challenging tasks, clear feedback, personal excellence</li>
        <li><strong>Affiliation (nAff)</strong>: Relationships, belonging, collaboration</li>
        <li><strong>Power (nPow)</strong>: Influence, leadership, control</li>
      </ul>
      <p><em>Match assignments to dominant needs.</em></p>
    </div>
  </div>
  <div class="theory-card maslow">
    <div class="theory-title">Maslow's Hierarchy of Needs</div>
    <div class="theory-content">
      <p>Needs must be met from bottom to top:</p>
      <ol>
        <li><strong>Physiological</strong>: Food, water, rest</li>
        <li><strong>Safety</strong>: Job security, physical safety</li>
        <li><strong>Social/Belonging</strong>: Team connection, friendship</li>
        <li><strong>Esteem</strong>: Recognition, respect</li>
        <li><strong>Self-Actualization</strong>: Creativity, reaching potential</li>
      </ol>
      <p><em>People can't focus on growth if they're worried about job security.</em></p>
    </div>
  </div>
  <div class="theory-card xy">
    <div class="theory-title">McGregor's Theory X & Y</div>
    <div class="theory-content">
      <p><strong>Theory X</strong>: "People hate work and must be controlled." Manager = Dictator. Close supervision required.</p>
      <p><strong>Theory Y</strong>: "People want to contribute and grow." Manager = Servant Leader. Empower and delegate.</p>
      <p><em>Agile and modern management assume Theory Y.</em></p>
    </div>
  </div>
  <div class="theory-card drive">
    <div class="theory-title">Pink's Drive (Autonomy, Mastery, Purpose)</div>
    <div class="theory-content">
      <p>For knowledge workers, intrinsic motivation beats rewards:</p>
      <ul>
        <li><strong>Autonomy</strong>: Control over how to work</li>
        <li><strong>Mastery</strong>: The urge to get better</li>
        <li><strong>Purpose</strong>: Contributing to something meaningful</li>
      </ul>
      <p><em>Modern default for software/creative teams.</em></p>
    </div>
  </div>
  <div class="theory-card vroom">
    <div class="theory-title">Vroom's Expectancy Theory</div>
    <div class="theory-content">
      <p><strong>Motivation = Expectancy × Instrumentality × Valence</strong></p>
      <ul>
        <li><strong>Expectancy (E)</strong>: "If I try, can I do it?"</li>
        <li><strong>Instrumentality (I)</strong>: "If I do it, will I get the reward?"</li>
        <li><strong>Valence (V)</strong>: "Do I actually want the reward?"</li>
      </ul>
      <p><em>If ANY factor is zero, motivation is zero.</em></p>
    </div>
  </div>
  <div class="theory-card theory-z">
    <div class="theory-title">Ouchi's Theory Z</div>
    <div class="theory-content">
      <p>Japanese management style focused on:</p>
      <ul>
        <li><strong>Long-term employment</strong></li>
        <li><strong>Collective decision-making</strong></li>
        <li><strong>Holistic concern for employee well-being</strong></li>
      </ul>
      <p><em>Loyalty and trust build over time.</em></p>
    </div>
  </div>
  <div class="theory-card equity">
    <div class="theory-title">Adams' Equity Theory</div>
    <div class="theory-content">
      <p>People compare their effort-to-reward ratio with others.</p>
      <p>If they perceive inequity:</p>
      <ul>
        <li>Reduce effort ("Why try if I'm not rewarded fairly?")</li>
        <li>Request more reward</li>
        <li>Rationalize or leave</li>
      </ul>
      <p><em>Fairness and transparency are essential.</em></p>
    </div>
  </div>
</div>
...
.maslow { border-top: 4px solid #10b981; }
.drive { border-top: 4px solid #ec4899; }
.vroom { border-top: 4px solid #06b6d4; }
.theory-z { border-top: 4px solid #6b7280; }
.equity { border-top: 4px solid #ef4444; }
