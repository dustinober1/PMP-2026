...
<ConceptGrid>
  <ConceptCard
    title="9.1 Control & Change"
    href="./monitoring-closing"
  >
    Turn data into decisions: EVM, critical path & schedule compression, reserves, and Integrated Change Control.
  </ConceptCard>
  <ConceptCard
    title="9.2 Project Closure"
    href="./project-closure"
  >
    Formal acceptance, transition readiness, procurement closure/claims, and turning project work into reusable OPAs.
  </ConceptCard>
  <ConceptCard
    title="9.3 Tools & Templates"
    href="./toolkit"
  >
    Copy/paste templates: status reporting, EVM worksheet, variance/issue logs, change requests, decision log, and closure artifacts.
  </ConceptCard>
  <ConceptCard
  ...
  >
    Test your ability to interpret performance metrics and closing requirements.
  </ConceptCard>
</ConceptGrid>
