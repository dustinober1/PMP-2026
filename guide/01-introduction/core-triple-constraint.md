...
**Predictive**: Defined in detail upfront (WBS, requirements spec).
**Agile**: Emerges over time (Product Vision, prioritized Backlog).
...
**Predictive**: Detailed master schedule with clear milestones.
**Agile**: Timeboxed iterations (sprints) with velocity-based planning.
