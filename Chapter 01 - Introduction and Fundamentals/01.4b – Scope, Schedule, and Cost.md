## 1.4b – Scope, Schedule, and Cost: The Triple Constraint and Its Modern Evolution
...
### 1.4b.2 The Modern View: Constraints and Priorities
...
### 1.4b.3 The Iron Triangle vs. The Diamond: Rethinking Success
...
3. **Estimate duration**: How long will each activity take?
   ...
   *For three-point estimation formulas and examples, see [Appendix B: Three-Point Estimating](../Appendices/Appendix%20B%20–%20Key%20Formulas%20and%20Definitions.md#three-point-estimating)*
...
4. **Build the schedule**: Using a tool like Gantt charts or network diagrams (CPM), determine:
   ...
   *For critical path method formulas and calculations, see [Appendix B: Critical Path and Duration Calculations](../Appendices/Appendix%20B%20–%20Key%20Formulas%20and%20Definitions.md#critical-path-and-duration-calculations)*
...
### 1.4b.8 On the Exam: Scope, Schedule, Cost Questions
