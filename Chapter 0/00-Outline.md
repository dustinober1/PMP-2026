# PMP Exam Study Guide (New Exam)

## Part 1 – Orientation and Exam Overview

### Chapter 1 – Understanding the New PMP Exam
- Purpose of the PMP certification
- Who the exam is for (experience, role, typical background)
- Exam structure
  - Number of questions
  - Time limit and breaks
  - Question types (multiple choice, multi-select, hotspot, etc.)
- High-level overview of domains
  - People
  - Process
  - Business Environment
- Balance of ways of working
  - Predictive
  - Agile
  - Hybrid

### Chapter 2 – How To Use This Study Guide
- How this guide is organized
- Mapping chapters to the Exam Content Outline (ECO)
- Recommended study paths
  - Fast-track plan (4–6 weeks)
  - Standard plan (8–12 weeks)
- How to integrate:
  - PMBOK and other PMI standards
  - Practice questions and mock exams
  - Class sessions and discussions
...
### Chapter 4 – Ways of Working and Tailoring
- Predictive (waterfall) approaches
- Agile approaches
- Hybrid approaches
- Tailoring: choosing fit-for-purpose practices
- Common roles:
  - Project manager
  - Product owner
...
- Quality concepts (fitness for use, conformance to requirements)
...
- Negotiating scope, schedule, and priorities
...
## Part 4 – Process Domain

### Chapter 10 – Starting the Project
- Business case and benefits overview
- Project charter and key components
- Understanding constraints and assumptions
- Selecting the delivery approach (predictive, agile, hybrid)
- High-level roadmap and initial release planning

### Chapter 11 – Planning for Value Delivery
- Collecting and refining requirements
- Defining scope (predictive vs agile views)
- Schedule development:
  - Work breakdown structures
  - Roadmaps, sprints, and iterations
- Cost planning and budgeting concepts
...
- Managing stakeholder engagement during execution
...
## Part 5 – Business Environment Domain

### Chapter 15 – Strategy, Portfolios, and Alignment
- Organizational strategy and objectives
- How projects support strategy and portfolios
