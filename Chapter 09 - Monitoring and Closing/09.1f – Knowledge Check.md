...
**See also**:
- [Section 9.1b: Earned Value Variance Analysis](09.1%20–%20Monitoring,%20Controlling,%20and%20Closing.md#earned-value-variance-analysis)
- [Appendix B: TCPI Formulas](../Appendices/Appendix%20B%20–%20Key%20Formulas%20and%20Definitions.md#additional-evm-formulas)
...
A) Use $10,000 from contingency and request $40,000 from management reserve
...
- D might be necessary if MR is unavailable, but MR should be used first

Since the MR ($50,000) can cover the full $50,000, request approval to use management reserve and update the baseline as needed.
...
**Note**: This knowledge check focuses heavily on Process domain concepts (monitoring, controlling, EVM) which is appropriate for Chapter 9's content. For People and Business Environment practice, see other knowledge checks.
