# Chapter 1 – Understanding the New PMP Exam
...
## 1.1 What Is the PMP and Why Does It Matter?

The Project Management Professional (PMP) is a globally recognized certification offered by the Project Management Institute (PMI). It is designed for people who lead or direct projects, regardless of industry or delivery approach (predictive, agile, or hybrid). ([Wikipedia][2]) It validates that you have the project leadership skills and experience to deliver results using any way of working, not just one specific methodology. ([Project Management Institute][1])
...
If you are earlier in your career and have limited project experience, PMI’s CAPM certification or other entry-level credentials may be more appropriate stepping stones. The PMP is intentionally positioned as a more advanced, professional-level certification. ([Project Management Institute][1])
...
PMI’s salary surveys consistently show that professionals with a PMP report noticeably higher median salaries than those without it (often cited around 16–33% higher globally, depending on the country and survey year). ([Project Management Institute][1]) Because of this, many organizations:
...
- It does not lock you into “waterfall” project management; it explicitly covers predictive, agile, and hybrid approaches. ([Project Management Institute][1])  
...
These percentages indicate roughly how many questions you can expect from each area. They come from PMI’s official Exam Content Outline (ECO) for the 2026 exam, which also defines “tasks” (what you do) and “enablers” (examples of how you do it) under each domain. ([Project Management Institute][1])
...
- Considering sustainability, environmental and social impact, governance, and other long-term consequences in project decisions. ([Pmproad][5])
...
Compared to the previous version of the exam (2021–2025), the weights shift significantly: ([Project Management Institute][1])
...
- Decision-making that considers:
  ...
  - AI and automation as practical tools in planning, monitoring, and reporting ([Project Management Institute][1])
...
If you have been doing these kinds of activities—even under titles like “team lead,” “business analyst,” “coordinator,” “product owner,” or “implementation specialist”—you may have qualifying experience. ([Project Management Institute][1])
...
- Starting with an entry-level certification like CAPM while you build up experience. ([Project Management Institute][1])
