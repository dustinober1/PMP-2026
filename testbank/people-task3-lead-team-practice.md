# PMP Hard-Mode Practice Exam: People Task 3 (Lead the Project Team)
...
| :--- | :--- | :--- |
| **1. Establish expectations** | 3, 10, 18, 25, 33, 40, 47 | 7 |
| **2. Empower the team** | 2, 11, 17, 24, 27, 34, 41, 48 | 8 |
| **3. Solve problems** | 4, 8, 15, 19, 28, 35, 42, 49 | 8 |
| **4. Represent the voice of the team** | 6, 13, 22, 29, 36, 43 | 6 |
| **5. Support varied perspectives** | 5, 12, 20, 30, 37, 44 | 6 |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The team is in the Norming or Performing stage but is suffering from "Groupthink" or a lack of psychological safety. The Supporting style (S3) is used when the team has high skills but needs facilitation in shared decision-making. |
| **PMI Mindset** | Facilitating dialogue is better than taking over (Directing) or ignoring the safety issue (Delegating). |
| **The Trap** | Staying in Delegating is tempting because the team is hitting milestones, but this ignores the underlying risk of technical debt. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Empowerment requires protecting the team's autonomy within the sprint boundaries. Clarifying the "Definition of Ready" and sprint rules is the first step. |
| **PMI Mindset** | Agile PMs act as servant leaders who protect the team from external interference. Solving the problem at the source is preferred. |
| **The Trap** | Escalation is often a distractor. The PM should first try to resolve the conflict by reinforcing established working agreements. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Hybrid projects require a "Bridge-Oriented" execution. Team charters and working agreements are essential to align purpose and set communication norms. |
| **PMI Mindset** | When methodologies clash, the solution is to establish shared governance and communication norms, not to force one methodology onto the other. |
| **The Trap** | Mandating a predictive schedule for an agile team violates the core principles of hybrid management. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | According to Herzberg's theory and Pink's Drive (Mastery), once hygiene factors are met, the PM must focus on motivators like growth and responsibility. |
| **PMI Mindset** | Diagnosing the environment and applying intrinsic motivators is the preferred path. Throwing money at a motivation problem is a trap. |
| **The Trap** | PIPs are usually the wrong first answer unless informal coaching and support have already failed. |
| **Source Link** | `guide/03-team-leadership/motivation-performance.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Global teams require "Asynchronous Ops" and "Digital Culture." Supporting varied perspectives requires making communication accessible to everyone. |
| **PMI Mindset** | Inclusion isn't just about being in the meeting; it's about having an equitable voice through an async-friendly model. |
| **The Trap** | Mandating cameras is a reactive move that doesn't address the underlying issue of inequitable communication flow. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Representing the team involves protecting them from interruptions. The Work Authorization System is a way to control how work begins. |
| **PMI Mindset** | The PM must be the "heat shield" for the team through direct, assertive communication with high-power stakeholders. |
| **The Trap** | Presenting the data at a committee meeting is too passive and delayed for a problem impacting the team right now. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The "Definition of Done" (DoD) is a critical execution tool. The PM should use a RACI to ensure work flows without quality gaps. |
| **PMI Mindset** | Process problems are solved by clarifying agreements and definitions, not just by adding more resources. |
| **The Trap** | Adding more people might help temporarily, but it doesn't solve the communication breakdown between the two groups. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Agile teams are self-organizing. Solving problems involves referring back to working agreements like the Team Charter. |
| **PMI Mindset** | PMs should use retrospectives to let the team solve their own dynamics. Intervening by assigning tasks destroys self-organization. |
| **The Trap** | Rewarding the senior developer would reinforce the negative behavior and further alienate the rest of the team. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The teams are in the "Storming" phase. The Coaching style (S2) is high direction and high support, needed to bridge the gap in understanding. |
| **PMI Mindset** | Hybrid leaders must be "Bridge-Oriented," explaining the system of work while supporting the emotional transition. |
| **The Trap** | Simply supporting is insufficient when there is a fundamental process conflict that requires the PM's facilitation. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Project Charter is the "Source of Truth" for authority and governance. PMs must align on purpose and authority early. |
| **PMI Mindset** | Always look at the governance documents (Charter/Plan) before escalating to the Sponsor. |
| **The Trap** | Escalating to the Sponsor is a common reactive mistake. The PM should first check existing documentation. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Empowerment involves removing impediments to restore flow. Blockers should be removed immediately rather than waiting for ceremonies. |
| **PMI Mindset** | Agile teams must be proactive. Servant leadership involves coaching the team to manage their own flow efficiently. |
| **The Trap** | Adding more meetings or more reporting adds waste and decreases team autonomy. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Psychological safety is the #1 predictor of success. Mentoring the expert addresses the root cause while maintaining their contribution. |
| **PMI Mindset** | Manage performance issues privately. The PM should aim to coach behavioral gaps rather than just punishing or ignoring them. |
| **The Trap** | Creating a separate group is a "silo" approach that fails to fix the team's culture and creates "us vs. them" dynamics. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Representing the team involves advocacy and transparency. People can't focus on growth if they are worried about basic security. |
| **PMI Mindset** | Servant leaders advocate for their team's value and maintain honesty. False reassurances are a violation of ethics and trust. |
| **The Trap** | Waiting for a final decision allows anxiety and rumors to fester, which is more damaging to productivity. |
| **Source Link** | `guide/03-team-leadership/motivation-performance.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Roles must be clarified through "Clarity → Support → Escalate." PMs must use a RACI and update it as reality evolves. |
| **PMI Mindset** | Collaborative updates ensure buy-in. The PM shouldn't just "hand down" roles without team participation. |
| **The Trap** | Assigning authority to seniors without a team session misses the opportunity to ensure collective understanding of the new process. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Visual management and removing impediments are essential. WIP limits and swarming are standard tools for managing flow in hybrid environments. |
| **PMI Mindset** | Team members should be "T-shaped," helping in other areas to maintain flow. "Not my job" is an execution anti-pattern. |
| **The Trap** | Hiring more people is expensive and doesn't fix the underlying process issue of uncontrolled work-in-progress. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In the Storming stage, the PM should use a Coaching style. Facilitating conflict involves bringing data and aligning on a decision rule. |
| **PMI Mindset** | Facilitating a decision is better than dictating one. It builds the team's ability to solve future problems together. |
| **The Trap** | Using technical authority is tempting but misses the chance to move the team toward the Norming stage. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Leaders must model fallibility to build trust. Empowerment cannot be forced; it must be grown through psychological safety. |
| **PMI Mindset** | Culture change takes time. The PM must lead by example and prove that mistakes won't be punished before the team will take initiative. |
| **The Trap** | Mandating independence is a paradox that does not fix the underlying fear of failure. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Establishing expectations involves a clear Definition of Done. The retrospective should be used to improve the system of work. |
| **PMI Mindset** | Quality should be built-in, not inspected-in. Refining the DoD ensures everyone knows what "done" truly means. |
| **The Trap** | Creating a separate team creates silos and slows down the agile delivery flow. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | According to Equity Theory, the PM must ensure a reasonable workload. Overwork leads to burnout and quality issues. |
| **PMI Mindset** | Recognize the signs of burnout. Rewards do not fix an unsustainable workload that is impacting quality. |
| **The Trap** | Hiring more people takes time and might actually increase the senior person's workload during the initial training phase. |
| **Source Link** | `guide/03-team-leadership/motivation-performance.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Diversity is a strength if managed through working agreements. PMs should transform strangers into a cohesive delivery engine. |
| **PMI Mindset** | Hybrid leaders find the middle ground that satisfies governance without killing team agility. |
| **The Trap** | Allowing separate methods leads to massive integration issues and "us vs. them" silos. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Agile teams strive for "T-shaped" skills. Pair programming and shadowing are best for transferring knowledge and reducing bottlenecks. |
| **PMI Mindset** | Solve resource constraints through development rather than just hiring or formalizing functional silos. |
| **The Trap** | Formalizing the silo makes the bottleneck permanent and the team more fragile to resource loss. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Representing the team involves advocating for them and removing impediments. PMs must convert raw data into actionable root-cause information. |
| **PMI Mindset** | The PM must be a "heat shield," using facts to explain delays rather than allowing unfair blame to be placed on the team. |
| **The Trap** | Staying silent is a failure of leadership that will destroy morale when the subsequent weekend-work mandate arrives. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In the Performing stage, the style is Delegating (S4). The role shifts to "getting out of the way" while still removing external blockers. |
| **PMI Mindset** | Servant leadership in high-performing teams is about "clearing the path," not "leading the charge." |
| **The Trap** | Reverting to Directing is a common mistake by PMs who feel they need to justify their presence through control. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Empowerment involves autonomy and mastery. Value-based decisions are encouraged in agile/hybrid, with formalization following proven value. |
| **PMI Mindset** | Value delivery is the primary goal. Trusting an expert to make a high-value improvement is key to servant leadership. |
| **The Trap** | Sticking to a rigid plan when a high-value improvement is available is a predictive mindset trap in a hybrid context. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Forming stage requires clear roles. Using a RACI prevents matrix organization negotiation issues and role confusion. |
| **PMI Mindset** | The PM should facilitate role clarity based on project needs, not just job titles or seniority in the organization. |
| **The Trap** | Letting the team decide during the Forming stage often leads to Storming prematurely and can create power struggles. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Resource constraints require negotiating with functional managers for resource protection. The charter is the authority for these commitments. |
| **PMI Mindset** | Professional negotiation is the first step when functional silos conflict with established project needs. |
| **The Trap** | Escalation is a later step; the PM should first try to resolve the conflict directly with the peer manager. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Pink's Drive (Mastery) suggests that pair programming is the best low-investment way to transfer tacit knowledge and empower members. |
| **PMI Mindset** | Servant leaders look for organic growth opportunities within the flow of work rather than just external training. |
| **The Trap** | Rewarding the senior developer reinforces a "Silo" culture that creates a single point of failure for the project. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Removing impediments is the priority. Execution includes reviewing contract terms and escalating to vendor management for late deliveries. |
| **PMI Mindset** | Act with urgency on critical path blockers. Do not just accept delays without trying to remove the root blocker. |
| **The Trap** | Re-baselining the schedule is a last resort move, not an appropriate first action for a PM. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Representing the team includes protecting them from interruptions. The sprint is a timebox that should not be interrupted mid-cycle. |
| **PMI Mindset** | The Scrum Master must educate the Product Owner on agile principles to protect the team's sustainable pace. |
| **The Trap** | Canceling the sprint is an extreme last resort; education and negotiation should always come first. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Inclusion involves consensus-driven decisions. Diversity and inclusion are ways to solve problems better through collaboration. |
| **PMI Mindset** | Professional collaboration on the "how" of work is more effective than just social events for resolving deep-seated friction. |
| **The Trap** | Social events are good, but they don't solve the underlying process conflict causing the actual resentment. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | For a team in the Norming stage, the correct style is Supporting (S3), which involves facilitating shared decision-making. |
| **PMI Mindset** | Leaders must evolve with the team. Micromanagement is often a failure to shift from Coaching (S2) to Supporting (S3). |
| **The Trap** | Jumping straight to Delegating (S4) is premature for a team that is just entering the Norming stage. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | New members cause regression. Working Agreements and Team Charters are the tools to align new members on decision models. |
| **PMI Mindset** | Use existing team governance to onboard new members rather than creating new hierarchies or being punitive. |
| **The Trap** | Appointing a formal lead in a self-organizing agile team is an execution anti-pattern. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Implementing approved changes requires following the established change approach. Aligning teams on this "Bridge" is essential. |
| **PMI Mindset** | Hybrid PMs must bridge agile flexibility with predictive control through clear, shared governance rules. |
| **The Trap** | Killing agile feedback or forcing predictive teams to be fully agile both ignore the benefits of the hybrid model. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Leaders must react positively to mistakes. Aligning rewards with "Learning" fosters an environment where bad news travels fast. |
| **PMI Mindset** | Intrinsic motivators and systemic safety (Reward systems) are more effective than mandated reporting. |
| **The Trap** | Failure Parties can feel condescending or forced if the underlying culture is still one of fear and blame. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Standups should be 15 minutes max, and problem-solving should happen offline. Enforcing this is a key Scrum Master responsibility. |
| **PMI Mindset** | Protect the team's time. Facilitate a separate space for deep dives so the rest of the team can get back to work. |
| **The Trap** | Dictating a solution violates self-organization; the PM should facilitate the space for the team to decide themselves. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Representing the team involves advocating for them and protecting them from unfair attacks or interruptions. |
| **PMI Mindset** | Servant leaders protect team members from public humiliation and unfair blame while maintaining professional relationships. |
| **The Trap** | Silence in the face of public unfairness is a failure to protect the team's psychological safety and morale. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Supporting varied experiences requires tacit knowledge transfer and coaching to manage the transition to new technology. |
| **PMI Mindset** | Help the team adapt to new technology through mentorship and shared governance rather than force or total avoidance. |
| **The Trap** | Mandating usage increases the safety risk and job security anxiety, which negatively impacts sustainable performance. |
| **Source Link** | `guide/03-team-leadership/motivation-performance.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The team is in the Forming stage. The appropriate style is Directing (S1), providing high direction and structure. |
| **PMI Mindset** | New teams need structure and clarity before they can self-organize. Delegating prematurely is a recipe for failure. |
| **The Trap** | Delegating is a common agile trap; even agile teams need more structure in the very first days of Forming. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Hybrid requires Bridge-Oriented execution. PMs must use integration points to bridge the predictive and adaptive layers. |
| **PMI Mindset** | The PM must facilitate a compromise that balances governance needs with the desire for agility. |
| **The Trap** | Picking a side fails to address the legitimate needs of the other methodology's stakeholders. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Team Charters and Ground Rules are essential for setting rules. Co-creation with the team ensures necessary buy-in. |
| **PMI Mindset** | Even for an existing team, if ground rules are missing, they must be established through collaborative facilitation. |
| **The Trap** | Dictating rules is a Theory X approach that rarely works with professional knowledge workers. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Empowerment involves autonomy over how work is done. The DoD should enforce quality standards sustainably. |
| **PMI Mindset** | Facilitate a more realistic definition of quality that balances value delivery with speed. |
| **The Trap** | Ignoring quality is a violation of agile principles and will lead to massive rework and technical debt later. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Holistic concern for well-being (Theory Z) and supporting personal situations builds long-term loyalty and performance. |
| **PMI Mindset** | Servant leaders look for win-win flexibility rather than being punitive or dismissive of individual needs. |
| **The Trap** | "Schedule first" is a short-sighted approach that often leads to losing high-quality talent. |
| **Source Link** | `guide/03-team-leadership/motivation-performance.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Representing the team involves removing organizational impediments. Hierarchical cultures often need bridge-building for agile success. |
| **PMI Mindset** | Solve the underlying organizational blocker (the manual review) rather than just accepting a broken process. |
| **The Trap** | Reverting to predictive methodology avoids the organizational problem rather than actually solving it. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Diversity and inclusion require understanding cultural context. Virtual leadership involves bridging these global gaps. |
| **PMI Mindset** | Facilitate an integrative solution that respects both perspectives rather than a win-lose or a weak compromise. |
| **The Trap** | Doubling the project cost to avoid conflict is a failure of scope and budget management. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Adding new members often knocks a team from Performing back to Storming. The style must revert to Coaching (S2). |
| **PMI Mindset** | Recognize regression and adapt leadership accordingly. Do not ignore the rising team friction. |
| **The Trap** | Staying in Delegating (S4) when the team has regressed will lead to a total breakdown in productivity. |
| **Source Link** | `guide/03-team-leadership/team-development.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Establishing roles involves educating stakeholders on the system of work. Use appropriate reports to package info. |
| **PMI Mindset** | Use agile-appropriate artifacts to provide visibility without forcing the team to revert to predictive tools. |
| **The Trap** | Doing both (shadow work) adds zero value to the team's delivery and increases administrative waste. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | PMs must protect shared resources from overload and context switching through optimized communication norms. |
| **PMI Mindset** | Protect the team's time by optimizing the communication system rather than just adding more head count. |
| **The Trap** | Just picking a meeting leads to information silos and missed alignment across the hybrid project. |
| **Source Link** | `guide/03-team-leadership/building-teams.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Empowerment involves control over how to work. Motivators like autonomy should be increased within safe guardrails. |
| **PMI Mindset** | Give the team clear guardrails (the triple constraints) and then let them drive within those boundaries. |
| **The Trap** | Removing all rules is a recipe for scope and budget chaos rather than healthy empowerment. |
| **Source Link** | `guide/03-team-leadership/motivation-performance.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Remove or escalate impediments to restore flow. When a risk occurs, it is an issue requiring an immediate impact assessment. |
| **PMI Mindset** | Agile PMs adapt the plan in real-time when major impediments are discovered. Collaboration with the PO is essential. |
| **The Trap** | Working overtime doesn't solve the long-term technical debt and is an unsustainable practice. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Run the system so work keeps flowing. Streamlining is a continuous improvement move for organizational processes. |
| **PMI Mindset** | Servant leaders remove waste (non-value-added work) from the team's process to improve overall efficiency. |
| **The Trap** | Hiring an admin adds cost without fixing the underlying inefficient process that creates the waste. |
| **Source Link** | `guide/08-execution/executing-work.md` |
...
3.  **Servant Leadership**: Your primary job is to "clear the path." Whether it's a technical blocker, a functional manager, or a bureaucratic process, if it slows the team down, it's your problem to solve.
4.  **Motivate Intrinsically**: Once fair pay (Hygiene) is met, people are driven by **Autonomy** (Control), **Mastery** (Growth), and **Purpose** (Meaning). Align tasks to these needs.
5.  **Conflict is Normal**: Don't suppress conflict in the "Storming" stage. Facilitate it so the team learns how to reach consensus and move to "Norming."
6.  **Protect the Flow**: Representing the team means protecting them from external "Scope Creep" and stakeholder interruptions. Use the Work Authorization System or Sprint rules as your "Heat Shield."
