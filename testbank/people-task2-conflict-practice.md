# Practice Exam: People Task 2: Manage Conflicts
...
| :--- | :--- | :--- |
| 1 | 1. Identify conflict sources | Predictive |
| 2 | 5. Establish environment / ground rules | Agile |
| 3 | 3. Implement resolution strategy | Hybrid |
| 4 | 2. Analyze the context | Predictive |
| 5 | 6. Manage/rectify ground rule violations | Agile |
| 6 | 3. Implement resolution strategy | Predictive |
| 7 | 4. Communicate principles | Hybrid |
| 8 | 1. Identify conflict sources | Agile |
| 9 | 3. Implement resolution strategy | Predictive |
| 10 | 2. Analyze the context | Hybrid |
| 11 | 3. Implement resolution strategy | Agile |
| 12 | 5. Establish environment / ground rules | Predictive |
| 13 | 6. Manage/rectify ground rule violations | Hybrid |
| 14 | 1. Identify conflict sources | Agile |
| 15 | 3. Implement resolution strategy | Predictive |
| 16 | 2. Analyze the context | Hybrid |
| 17 | 5. Establish environment / ground rules | Agile |
| 18 | 4. Communicate principles | Predictive |
| 19 | 3. Implement resolution strategy | Hybrid |
| 20 | 1. Identify conflict sources | Agile |
| 21 | 3. Implement resolution strategy | Predictive |
| 22 | 2. Analyze the context | Agile |
| 23 | 5. Establish environment / ground rules | Hybrid |
| 24 | 6. Manage/rectify ground rule violations | Predictive |
| 25 | 3. Implement resolution strategy | Agile |
| 26 | 1. Identify conflict sources | Hybrid |
| 27 | 2. Analyze the context | Predictive |
| 28 | 4. Communicate principles | Agile |
| 29 | 3. Implement resolution strategy | Hybrid |
| 30 | 1. Identify conflict sources | Predictive |
| 31 | 6. Manage/rectify ground rule violations | Agile |
| 32 | 3. Implement resolution strategy | Predictive |
| 33 | 2. Analyze the context | Hybrid |
| 34 | 1. Identify conflict sources | Agile |
| 35 | 5. Establish environment / ground rules | Predictive |
| 36 | 4. Communicate principles | Hybrid |
| 37 | 3. Implement resolution strategy | Agile |
| 38 | 2. Analyze the context | Predictive |
| 39 | 6. Manage/rectify ground rule violations | Hybrid |
| 40 | 1. Identify conflict sources | Agile |
| 41 | 3. Implement resolution strategy | Hybrid |
| 42 | 5. Establish environment / ground rules | Agile |
| 43 | 2. Analyze the context | Predictive |
| 44 | 6. Manage/rectify ground rule violations | Agile |
| 45 | 1. Identify conflict sources | Hybrid |
| 46 | 3. Implement resolution strategy | Predictive |
| 47 | 2. Analyze the context | Agile |
| 48 | 5. Establish environment / ground rules | Hybrid |
| 49 | 4. Communicate principles | Predictive |
| 50 | 3. Implement resolution strategy | Agile |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The scenario describes recurring conflict stemming from role confusion and process gaps (specifications vs. budget constraints). Updating the RACI matrix is a structural solution that addresses the system failure rather than just the symptom. |
| **PMI Mindset** | When conflict is recurring, the PM should look for structural or process-related fixes (e.g., RACI, working agreements) rather than just facilitating a one-time resolution. |
| **The Trap** | The action of instructing them to follow the change control process is tempting as it addresses documentation, but it doesn't fix the underlying "who decides what" issue that led to the friction. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In Agile, the team is self-organizing. The Scrum Master should facilitate a process where the team identifies the issue and adjusts their own ground rules (found in the Team Charter) to improve their working environment. |
| **PMI Mindset** | The Retrospective is the primary vehicle for process and environment improvements. The PM/Scrum Master should empower the team to self-correct rather than taking top-down disciplinary action immediately. |
| **The Trap** | The choice to meet privately is a valid conflict management step, but the "FIRST" and best action for an environment/ground rule issue in Agile is to let the team address it in the Retrospective. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The action of identifying underlying interests (Integrative Negotiation) and brainstorming options is the definition of the Collaborate/Problem Solve technique, which leads to a Win-Win outcome. |
| **PMI Mindset** | Collaborative problem solving is the default "best" technique because it addresses the root cause and maintains commitment. Compromise is a "lose-lose" or "partial win-win" and should only be used when time is too short for collaboration. |
| **The Trap** | The action of negotiating a compromise is tempting because it feels fair, but it results in both parties giving up something (Lose-Lose), whereas collaboration seeks to "expand the pie." |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When two parties of equal power are deadlocked and a quick decision is needed to move forward (avoiding delays to the project start), Compromise is an appropriate temporary or practical fix. |
| **PMI Mindset** | While Collaboration is preferred, the TKI model recognizes Compromise as the "middle ground" suitable for deadlocks between equal powers when time is a factor. |
| **The Trap** | The action of smoothing might feel like it helps the relationship, but it doesn't resolve the actual conflict over the finishes, which is the immediate barrier to progress. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Relationship conflict and ground rule violations should be addressed privately and early to prevent de-escalation. Addressing it privately avoids public shaming while still ensuring the behavior is corrected. |
| **PMI Mindset** | Private intervention is the second step in the conflict escalation ladder. Publicly calling someone out during a stand-up can worsen the relationship conflict. |
| **The Trap** | The choice to wait for the Retrospective is common in Agile, but for direct violations of ground rules that are damaging team morale, the PM/Scrum Master must intervene sooner. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | For issues involving safety, legal compliance, or severe emergencies, the Force/Direct technique is the only appropriate response. There is no room for negotiation when it comes to building codes and life safety. |
| **PMI Mindset** | Force is generally discouraged EXCEPT in cases of safety, compliance, or emergencies. The PM must take immediate action to protect the project and the public. |
| **The Trap** | The action of collaborating sounds better because it's "Win-Win," but in a safety/compliance emergency, time and regulation dictate the outcome, not creative brainstorming. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Communicating principles effectively involves documenting the process (Communication/Management Plan) and ensuring alignment through direct engagement (Kickoff). This sets clear expectations from the start. |
| **PMI Mindset** | Transparency and upfront alignment on processes are key to stakeholder management. The PM should ensure everyone knows the "rules of engagement." |
| **The Trap** | The choice to host a negotiation training session is proactive, but it doesn't communicate the specific project-level principles and escalation paths required for this specific project. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | While there is some personal frustration, the root of the disagreement is the work itself—specifically, what constitutes a "bug" versus the "Definition of Done." This is a Task Conflict. |
| **PMI Mindset** | Task conflict can be healthy if channeled into clarifying work standards. The PM should look past the emotional delivery to find the underlying work-related issue. |
| **The Trap** | The "looking busy" comment makes it feel like a Relationship Conflict, but the core issue is the disagreement over quality (Task). Addressing it as Relationship only would miss the process improvement opportunity. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Smoothing/Accommodating involves yielding to the other party's position to maintain harmony or because the issue is more important to them. Delaying the start to help the functional manager is a classic example. |
| **PMI Mindset** | Accommodating is a valid strategy when the relationship is more important than the immediate issue or when you are "bankrolling" a future favor. |
| **The Trap** | The choice to suggest 50% time is a Compromise, not Smoothing. Smoothing involves one side essentially giving in to the other's preference on that specific point. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The $50,000 cost of switching vendors is what happens if the negotiation fails. Therefore, it is the Best Alternative to a Negotiated Agreement (BATNA). Since the BATNA is more expensive than the vendor's ask, the PM has less leverage. |
| **PMI Mindset** | Understanding your BATNA is critical because it defines your walk-away point and your relative power in the negotiation. |
| **The Trap** | The "remaining budget" might feel like the Reservation Price, but the question specifically asks about the *alternative* path (switching vendors). |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When emotions are too high for productive discussion (Withdraw/Avoid temporarily) and more data is needed (Technical Spike), the best move is to pause and gather facts. |
| **PMI Mindset** | Temporary withdrawal is appropriate when emotions are high. Following up with a data-driven approach (Collaborate) ensures the issue is eventually resolved, not just ignored. |
| **The Trap** | The action of facilitating a vote (Majority) might feel "Agile," but it doesn't resolve the technical disagreement or the emotional tension; it just creates "winners" and "losers." |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Ground rules, documented in the Team Charter, are the primary tool for preventing conflict and managing meeting behavior. Developing them collaboratively increases buy-in. |
| **PMI Mindset** | Prevention is always better than cure. Ground rules set the standard for behavior *before* it becomes a significant source of conflict. |
| **The Trap** | The action of issuing a memorandum (Force/Direct) is less effective than collaborative ground-rule setting because it doesn't build consensus or commitment from the team. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Managing violations, especially with stakeholders, should start with private, professional communication to realign expectations. This preserves the relationship while correcting the behavior. |
| **PMI Mindset** | Private intervention is the first step in addressing a specific person's violation of rules. It allows for education and realignment without public embarrassment. |
| **The Trap** | The action of telling the team to ignore the stakeholder is a reactive measure that doesn't solve the stakeholder's underlying need for information or fix the relationship. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Disagreements about *how* the work is performed (Definition of Ready, workflow, handoffs) are Process Conflicts. Refining the process is the structural fix. |
| **PMI Mindset** | Distinguishing between the type of conflict helps the PM choose the right tool. Process issues require process updates, not just "talking it out." |
| **The Trap** | The "bureaucratic" comment makes it sound like a personal attack, but the root cause is the lack of a clear, agreed-upon process for story readiness. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When both parties have valid points, they are willing to cooperate, and there is time available, Collaboration (Problem Solving) is the best technique to reach a Win-Win solution that addresses the root technical issues. |
| **PMI Mindset** | Collaboration is the gold standard for PMP conflict resolution. It builds commitment and leads to the best technical outcome. |
| **The Trap** | The action of compromising (splitting the difference) might be faster, but it often results in a sub-optimal technical solution that satisfies neither engineer's primary concern. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The department head's *position* was "No access." Their *interest* was "Ensuring the lab remains clean and ready for their own work." By asking "why," the PM uncovered the interest. |
| **PMI Mindset** | Interest-based negotiation (Principled Negotiation) is the preferred PMP approach. It moves beyond "What they want" to "Why they want it." |
| **The Trap** | The action of looking for alternative facilities (BATNA) is a good backup, but the PM is currently in the middle of the negotiation itself, using interest-based tactics. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Working Agreements (or Team Charters) are essential for virtual teams to handle time zone and communication challenges. Collaborative creation ensures all members feel heard and committed to the rules. |
| **PMI Mindset** | In virtual environments, explicit ground rules for communication and decision-making are critical to prevent "proximity bias" and the resulting conflict. |
| **The Trap** | The action of directing communication through Slack (Force) might help with visibility but doesn't address the cultural and process issue of how decisions are made. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Communicating conflict management principles involves establishing "objective criteria" (standards that both sides agree on) to remove the battle of wills. This is a core part of principled negotiation. |
| **PMI Mindset** | For external stakeholders/vendors, relying on objective criteria (industry standards, contract terms) is the best way to manage conflict professionally and fairly. |
| **The Trap** | Escalating to legal (Arbitration) is a last resort. The PM should first try to communicate and agree on the "rules" for the conflict (objective criteria). |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When direct negotiation and facilitated collaboration fail because communication has broken down completely, bringing in a neutral mediator is the next step in the conflict escalation ladder. |
| **PMI Mindset** | Mediation is a low-friction way to restore communication before moving to high-friction options like formal escalation to the sponsor or litigation. |
| **The Trap** | Escalating to the sponsor is common, but the PM should first try to resolve it within the project's ecosystem using mediation before taking up the sponsor's time. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The "Personality Trap" occurs when people perceive task-based disagreements (architecture, code quality) as personal slights. Identifying the underlying task issue is the first step to resolution. |
| **PMI Mindset** | The PM should look for the process or task issue behind what appears to be a personality clash. Reframing the conflict as "Work-related" helps de-escalate it. |
| **The Trap** | Categorizing it as Relationship only (Distractor 1) would miss the chance to improve how the team handles technical disagreements and could lead to unnecessary team changes. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When two valid views are in conflict and there is extreme time pressure (30 minutes before a major meeting), Compromise is the best tool for a quick, acceptable resolution. |
| **PMI Mindset** | Collaboration is usually best, but time pressure is a classic signal that Compromise is the correct PMP answer for a "temporary or quick fix." |
| **The Trap** | Collaboration is the "default" best answer, but it requires "Time and Trust." In this scenario, the 30-minute deadline makes it unrealistic. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The shift from problem-solving ("best for product") to blame-avoidance ("I won't be responsible") indicates an escalating conflict where emotions and self-interest are overriding objective work goals. |
| **PMI Mindset** | The PM/Scrum Master must be able to "read the room" and identify when a conflict is no longer productive (Task) and has become destructive (Personal/Escalated). |
| **The Trap** | The architectural focus makes it look like a Task Conflict, but the language of "I won't be responsible" signals that it has moved beyond the task itself. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Standardizing the decision-making model in the Team Charter (Ground Rules) provides clarity and reduces friction. Using a tool like "Fist of Five" is a recognized way to build consensus. |
| **PMI Mindset** | Explicitly defining *how* decisions are made is a key part of ground rules. It prevents "process conflict" by setting clear expectations. |
| **The Trap** | Implementing "Majority Rules" (Distractor 1) might be fast, but it alienates the "losers" and fails to build the long-term commitment that consensus-based models provide. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Since private intervention (Step 2) has failed and it's a safety/compliance issue, the PM must move to Step 5 (Escalation) of the conflict/dispute ladder. |
| **PMI Mindset** | Escalation is appropriate when internal attempts at resolution have failed, or when authority beyond the PM's direct control is required to enforce compliance. |
| **The Trap** | Termination (Distractor 1) is a very extreme measure that usually requires legal/procurement involvement and more formal documentation than what has been described so far. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Collaboration (Problem Solving) involves looking at the underlying interests (speed vs. risk) and creating a new solution (Hybrid strategy) that satisfies both. This is the definition of Win-Win. |
| **PMI Mindset** | The PM/Scrum Master should guide the team to find a "third way" that incorporates the best parts of both arguments rather than picking a winner and a loser. |
| **The Trap** | The choice of "Compromise" (Distractor 1) is a common trap. A hybrid strategy (Collaboration) is better than a split approach (Compromise) because it integrates the logic of both sides into one cohesive plan. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Competition for limited human or material resources is the classic definition of a Resource Conflict. It is one of the most common sources of project friction. |
| **PMI Mindset** | Identifying the source helps determine the resolution path—in this case, resource negotiation or escalation to a steering committee for prioritization. |
| **The Trap** | It's easy to call this a "Schedule Conflict," but the root cause isn't the calendar itself—it's the fact that two different entities are trying to use the same limited resource at the same time. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Accommodating (Smoothing) is the best strategy when the issue is minor to you but the relationship is vital. Yielding on a small cost builds goodwill for future high-stakes negotiations. |
| **PMI Mindset** | The PM must be strategic about which battles to fight. Smoothing is an investment in relationship capital. |
| **The Trap** | While Collaboration (Distractor 1) is usually the "best" answer, for a truly minor issue ($500 in a large project), the time spent on a collaborative session might cost more than the fee itself. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Communicating principles involves education (coaching on Agile principles) and establishing a clear process for handling the source of the conflict (emergency changes). |
| **PMI Mindset** | The Scrum Master acts as a coach to both the team and the PO. Resolving conflict in Agile often involves realigning everyone with core Agile values and processes. |
| **The Trap** | While Distractor 2 avoids an immediate argument, it ignores the root cause and allows for scope creep, which will eventually lead to more intense conflict. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Knowing the other party's BATNA (cancellation cost) gives you leverage. By calmly highlighting this, the PM can steer the negotiation back to objective criteria (principled negotiation). |
| **PMI Mindset** | Negotiation should be based on logic and data (objective criteria), not on emotional threats. Understanding BATNAs prevents you from being bullied by unrealistic demands. |
| **The Trap** | Distractor 3 (Compromise) is tempting, but it gives in to the customer's unreasonable position when the PM actually holds the leverage in the relationship. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Disagreements about timing, deadlines, and milestones are the definition of Schedule Conflicts. They are often driven by different organizational priorities (Holiday sales vs. Operational readiness). |
| **PMI Mindset** | Schedule issues are the #1 source of project conflict. Identifying it correctly allows the PM to look for ways to align the timeline or escalate for a strategic decision. |
| **The Trap** | It's easy to call this "Technical" (Distractor 2), but the core of the fight is about *when* the work happens, not *how* the machines work. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In a self-organizing agile team, the first line of defense for ground rule violations should be the team itself. The retrospective is the appropriate forum for the team to hold each other accountable. |
| **PMI Mindset** | The PM/Scrum Master should facilitate self-correction rather than jumping in as a "boss" immediately, especially for behavioral issues that affect the whole team. |
| **The Trap** | While private intervention (Distractor 1) is a valid step in the conflict ladder, the *best* move in Agile is to empower the team to handle its own working agreements first. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Postponing a decision to gather more data (the audit) is the definition of the Withdraw/Avoid technique. It is often used when a PM feels they lack the information to make a sound decision. |
| **PMI Mindset** | Withdrawal is a temporary measure. While it can be seen as negative, it is a valid choice when the PM needs more facts (data-driven decision making) to resolve a complex technical conflict. |
| **The Trap** | Distractor 1 (Smoothing) might feel right because of "compliance," but the question asks to identify the *strategy being used* (postponing), which is clearly Withdrawal. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Context analysis for conflict involves understanding not just the *what* (features) but the *who* (power dynamics, styles). Tailoring facilitation to manage aggressive vs. reserved stakeholders is key to resolution. |
| **PMI Mindset** | Stakeholder management and conflict resolution are deeply linked. The PM must understand the "political" landscape of the project to successfully navigate high-stakes disagreements. |
| **The Trap** | While they *are* fighting over capacity (Resource Conflict), the scenario focuses on the *behavior* in the meetings (aggressive vs. reserved), which requires a context-based analysis of the people involved. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The source of the friction is the *way* work is managed (changing criteria mid-sprint), which is a process issue. Fixing the "rules of the game" (Process) will resolve the conflict. |
| **PMI Mindset** | Most conflicts that look like "work" or "personality" issues are actually rooted in poorly defined or poorly followed processes. |
| **The Trap** | It's tempting to call this "Task Conflict" because it involves the requirements (acceptance criteria), but the *timing* of the change is what violates the process and causes the friction. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A Conflict Log specifically tracks parties, issues, resolution modes, and outcomes. It helps the PM see if the same people or departments are consistently at odds, allowing for structural fixes. |
| **PMI Mindset** | Documentation of conflict is not just for records; it's a diagnostic tool. Patterns in the conflict log reveal systemic issues in the project's governance or culture. |
| **The Trap** | While an Issue Log (Distractor 3) is similar, the PMP specifically recognizes a Conflict Log as the tool for tracking interpersonal and departmental friction. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Principled negotiation (separating people from problems, focusing on interests, and using objective criteria) is the best way to handle a competitive negotiator while maintaining your own principles. |
| **PMI Mindset** | The PM should never lower their own ethical or professional standards just because the other party is being difficult. Staying data-driven (objective criteria) is the ultimate defense. |
| **The Trap** | Matching the vendor's style (Distractor 1) is a common reactive mistake that often leads to a "Death Spiral" of escalating conflict and damaged relationships. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Consent-based (or Consensus) decision making ("Can you live with it?") is faster than unanimity but provides higher buy-in than majority voting. It ensures no one will sabotage the outcome. |
| **PMI Mindset** | For important team decisions, high buy-in is critical. Consent-based models balance the need for speed with the need for commitment. |
| **The Trap** | Majority voting (Distractor 2) is faster but can create a "loser" group that may not fully commit to the new testing tool, leading to future conflict. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Once conflict becomes personal and public, Level 1 (Self-Correction) is no longer sufficient. The PM must move to Level 2 (Private Intervention) to stop the relationship damage. |
| **PMI Mindset** | Understanding when "watching and waiting" is no longer appropriate is a critical PM skill. Relationship conflict requires earlier intervention than task conflict. |
| **The Trap** | While it *is* a personal attack (Distractor 2), you don't jump straight to the Sponsor. You move up the ladder one step at a time, starting with a private intervention by the PM. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A "plus/delta" review (What worked / What needs to change) is a healthy, systematic feedback loop. It allows the team to reflect on their own behavior and rectify violations collectively. |
| **PMI Mindset** | Effective management of ground rules involves consistent, visible feedback that encourages self-correction and continuous improvement. |
| **The Trap** | "Naming and Shaming" (Distractor 2) is a destructive way to manage violations that will likely damage trust and create relationship conflict. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Conflict requires two or more parties (people or groups) with perceived incompatible goals. A technical error or a "fight" with code is an impediment, not a conflict in the PMP sense. |
| **PMI Mindset** | Distinguishing between "human conflict" and "technical impediments" ensures the PM uses the right tool. You don't "negotiate" with a broken API; you fix it. |
| **The Trap** | The language of "having conflict with" (Distractor 1) is a common way people speak, but for the exam, conflict is strictly an interpersonal or inter-departmental phenomenon. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Compromise involves both sides giving up something (dev team waits a little/limits the release, compliance team accepts less documentation initially) to reach a quick, acceptable deal. |
| **PMI Mindset** | Compromise is a "middle-of-the-road" strategy. It is useful for temporary fixes but often results in a "Lose-Lose" where neither side is fully satisfied. |
| **The Trap** | Distractor 2 (Automation) is Collaboration, which is the "best" long-term solution but often requires more time than a simple Compromise. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Plurality is when the option with the most votes wins, even if it doesn't reach 50%. In this case, 4 votes out of 12 total is not a majority. |
| **PMI Mindset** | Understanding the different voting models (Majority vs. Plurality) is important for facilitating quick team decisions. |
| **The Trap** | People often confuse "Plurality" with "Majority." Majority strictly requires more than half of the total votes. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The ZOPA is the overlap between the buyer's maximum price and the seller's minimum price. If the buyer's maximum is higher than the seller's minimum, a deal is possible. |
| **PMI Mindset** | Identifying the ZOPA helps the PM understand the flexibility available during the negotiation. |
| **The Trap** | BATNA (Distractor 1) is what you do if the negotiation fails (e.g., go to a different vendor); it is not the range of prices itself. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Handling emotional situations requires immediate de-escalation (taking a break) followed by private intervention to address the root cause—in this case, a poorly defined or misapplied ground rule. |
| **PMI Mindset** | Relationship conflict should be handled privately and with empathy. Ground rules should be used to build the team up, not tear individuals down. |
| **The Trap** | Public reprimands (Distractor 2) usually escalate the conflict and damage the overall team environment. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Disagreements about technical approaches, quality standards, and the "best way" to do the work are Task Conflicts. These are common in projects involving multiple organizations with different perspectives. |
| **PMI Mindset** | Identifying conflict as "Task-related" allows the PM to move the discussion back to data, requirements, and objective criteria rather than personal blame. |
| **The Trap** | While there might be some personal friction (Distractor 1), the root of the disagreement is the technical strategy (Standard best practices vs. Legacy constraints). |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Collaboration (Problem Solving) involves using data (cost-benefit analysis) and spending time to find a Win-Win solution that satisfies the "interests" of both parties (Sales and Efficiency). |
| **PMI Mindset** | Collaboration is the "default" best approach because it leads to the highest commitment and the best outcome for the organization. |
| **The Trap** | People often pick Compromise (Distractor 1) whenever they see two sides talking, but true Collaboration seeks the *optimal* solution, not just a middle-ground one. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Disagreements about roles, responsibilities, and "how we work together" are Process Conflicts. Refining the Team Charter/Working Agreement is the standard fix. |
| **PMI Mindset** | Agile teams must be self-organizing. Conflict over administrative roles is usually a sign that the team needs to realign on Agile values and their own ground rules. |
| **The Trap** | "Too busy" (Distractor 3) is a symptom, but the conflict itself is about the *process* of whose responsibility it is. |
| **Source Link** | guide/03-team-leadership/conflict-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Proactive communication of ground rules during onboarding is the best way to prevent conflict. Explaining the "why" (the interests behind the rules) increases buy-in. |
| **PMI Mindset** | Prevention is always the first line of defense. Ensuring all stakeholders are aligned with the project's culture from day one reduces future friction. |
| **The Trap** | Wait and see (Distractor 2) is a reactive strategy that allows unnecessary conflict to damage the project's momentum. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Effective communication involves providing the "right information to the right people at the right time." A summary in a status report provides transparency without overwhelming stakeholders with minor details. |
| **PMI Mindset** | Transparency is an ethical requirement, but the PM must also manage the *volume* of information. Detailed interpersonal conflict logs should usually remain private to the parties involved. |
| **The Trap** | Distractor 1 (Full log) is a violation of privacy and can actually increase conflict by making minor disagreements public. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The WIN Framework (What, Interests, New Options) is a simplified version of interest-based negotiation. "Interests" focuses on the "why" behind the demands. |
| **PMI Mindset** | PMP questions often test specific frameworks. Knowing that "Interests" is the core of principled negotiation is key to choosing the right answer. |
| **The Trap** | "Implementation" (Distractor 1) sounds plausible in a technical context, but it skips the critical step of understanding *why* the conflict exists in the first place. |
| **Source Link** | guide/04-stakeholder/conflict-negotiation.md |
