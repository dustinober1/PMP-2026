...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | High Power / Low Interest stakeholders fall into the "Keep Satisfied" quadrant. The goal is to ensure their needs are met without overwhelming them with information they find irrelevant. |
| **PMI Mindset** | The PM must adapt the communication style and frequency based on the power/interest mapping to optimize engagement and resource usage. |
| **The Trap** | The trap is assuming a high-power stakeholder needs "Managed Closely," which would actually annoy a low-interest executive. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Specific constraints or needs stated by stakeholders are "Requirements." In this case, the time limitation is a constraint on how the PM designs the training. |
| **PMI Mindset** | Identifying and classifying expectations correctly allows the PM to address them in the project management plan. |
| **The Trap** | It is tempting to call this a success criterion, but success criteria are outcomes (e.g., "zero errors"), whereas this is a constraint on the process (the training). |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When expectations conflict, the PM should first facilitate a discussion and use the project's foundational documents (like the Charter) as a "North Star" to find common ground. |
| **PMI Mindset** | The PM acts as a facilitator, seeking win-win solutions or compromises that align with the project's business case and strategic objectives. |
| **The Trap** | Escalating to the sponsor is a premature move; the PM should first attempt to resolve the alignment issue through facilitation. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Mentoring involves direct engagement to build understanding and capability. Explaining the "why" helps align the stakeholder's expectations with the project's needs. |
| **PMI Mindset** | Servant leadership involves identifying gaps in stakeholder understanding and proactively coaching them to ensure project success. |
| **The Trap** | Delegating the training to a functional manager is less effective for project-specific alignment than direct mentoring by the PM. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Vendors are "Outward" stakeholders. Given the criticality of their component and their history, they have high power/influence over the project's success and must be managed closely. |
| **PMI Mindset** | The PM must recognize when a stakeholder's potential impact warrants more intensive engagement than their formal position might suggest. |
| **The Trap** | Assuming "External" automatically means "Monitor" or "Keep Informed" ignores the specific risk and influence profile of this critical vendor. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When expectations exceed scope, the PM must first return to the approved baseline documents (Charter, Scope Statement) to realign stakeholders with the project's reality. |
| **PMI Mindset** | Managing expectations requires transparency and a firm grounding in the project's authorized boundaries. |
| **The Trap** | Submitting a change request immediately is reactive; the first step is to communicate the current reality and align expectations. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In Agile, the PM facilitates alignment by helping stakeholders see the "Value" in different types of work. Connecting technical debt to business outcomes is key. |
| **PMI Mindset** | Facilitating shared understanding and collaborative decision-making is more effective than making unilateral decisions or just splitting the difference. |
| **The Trap** | While the Product Owner has authority, ignoring the Technical Lead's concerns without facilitation leads to poor long-term outcomes and technical debt. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Agile relies on transparency and frequent engagement. If stakeholders are surprised, the "Pull" communication (visibility into the backlog) or the engagement frequency is failing. |
| **PMI Mindset** | The PM should focus on improving the feedback loops and transparency rather than adding bureaucratic "Push" notifications. |
| **The Trap** | Blaming the Agile methodology ("expect changes without notice") is defensive and fails to address the underlying communication gap. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Transitioning stakeholders requires identifying their current state (Resistant) and using targeted engagement (demonstrating value) to move them toward support. |
| **PMI Mindset** | Resistance to change is common; the PM must act as a change agent, educating stakeholders on the benefits of the new way of working. |
| **The Trap** | Continuing old habits (Gantt charts) while trying to be agile (Sprint Reviews) creates confusion and doesn't solve the resistance. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Scrum Master's role is to coach the team and the Product Owner. Direct mentoring in the specific area of struggle (story mapping) addresses the root cause of the misalignment. |
| **PMI Mindset** | Servant leadership involves empowering others through coaching rather than taking over their responsibilities or adding external resources. |
| **The Trap** | "Taking over" is a common trap that undermines the Product Owner's role and fails to build the team's long-term capability. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Aligning expectations often requires educating stakeholders on the fundamental constraints of project management (Scope, Schedule, Cost, Quality). |
| **PMI Mindset** | The PM provides clarity on trade-offs, helping stakeholders make informed decisions about priorities. |
| **The Trap** | Proposing a hybrid approach without first explaining the trade-offs might lead to "fixed date AND fixed scope," which is a recipe for failure. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Stakeholder influence and interest change over time. In a hybrid project, the PM must adjust categorization based on the active phase and the stakeholder's relevance to it. |
| **PMI Mindset** | The Stakeholder Register is a living document. Categorization must reflect the current project reality. |
| **The Trap** | Keeping a stakeholder "High Power / High Interest" when they have no influence over the current work is an inefficient use of communication resources. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In hybrid projects, "hard" constraints (like compliance) must be integrated into the "flexible" processes (like Agile sprints) to ensure all expectations are met. |
| **PMI Mindset** | The PM finds ways to satisfy high-priority stakeholder needs (regulators) without completely abandoning the benefits of the chosen methodology. |
| **The Trap** | Creating a separate compliance silo (Distractor 1) often leads to late-stage discovery of compliance gaps and rework. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Hybrid projects require hybrid reporting. The PM must facilitate alignment by providing metrics that speak to both traditional and agile stakeholders. |
| **PMI Mindset** | The PM bridges the gap between different management styles by providing a holistic view of project health and value. |
| **The Trap** | Trying to "force" agile progress into a Gantt chart (Distractor 1) can be misleading and hides the true nature of iterative value delivery. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When misalignment stems from a lack of process understanding, the PM uses mentoring/coaching to bridge the gap and ensure the "ways of working" are understood by all. |
| **PMI Mindset** | Education and communication are the primary tools for resolving friction between different parts of a hybrid organization. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When a new key stakeholder is identified, the first step is always to update the stakeholder register and then assess their needs to align expectations. |
| **PMI Mindset** | The PM is proactive in identifying and engaging new stakeholders to prevent late-stage surprises or resistance. |
| **The Trap** | Sending a report (Distractor 2) before understanding the CISO's specific concerns is a "Push" communication that may not address the actual misalignment. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | New requirements or expectations that impact the baseline must go through the formal Integrated Change Control (ICC) process in a predictive environment. |
| **PMI Mindset** | Compliance and legal requirements are high priority. The PM must assess the impact and follow the established governance for any changes. |
| **The Trap** | Simply telling the stakeholder it's "outside scope" (Distractor 1) ignores the project's obligation to remain compliant and fails to align with the organization's needs. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Facilitation involves finding a middle ground that respects contractual constraints while meeting project needs. Reviewing the "Source of Truth" (the SLA) is the starting point. |
| **PMI Mindset** | The PM uses negotiation and facilitation to resolve conflicts between internal and external parties without immediately resorting to escalation. |
| **The Trap** | "Directing" a vendor to ignore their contract (Distractor 1) is unprofessional and likely to fail or lead to legal issues. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Mentoring stakeholders on the "Strategic Value" (the Business Case) helps them see beyond their departmental silo and aligns their expectations with the project's purpose. |
| **PMI Mindset** | The PM should build bridges through education and transparency rather than bypassing stakeholders or relying on authority. |
| **The Trap** | Adding more "Technical Data" (Distractor 2) may not help if the underlying issue is a lack of understanding of the business value. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Stakeholder Mapping tools are specifically designed to categorize stakeholders by their attributes (Power, Interest, Urgency, Legitimacy) to tailor engagement. |
| **PMI Mindset** | Systematic categorization is essential for managing large stakeholder groups and ensuring the right information reaches the right people. |
| **The Trap** | While a WBS (Distractor 2) involves stakeholders, it doesn't help categorize them for the purpose of aligning expectations and communication. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Salience Model categorizes stakeholders by Power, Urgency, and Legitimacy. High Urgency alone makes them "Demanding" stakeholders who need attention to prevent escalation. |
| **PMI Mindset** | The PM must recognize that urgency can be just as important as power in maintaining project health and stakeholder alignment. |
| **The Trap** | Dismissing stakeholders who lack "Power" (Distractor 1) is a common mistake that leads to public relations issues and project delays. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Collaborative prioritization techniques (WSJF, Buy a Feature) help stakeholders understand the trade-offs and reach a consensus on what provides the most value. |
| **PMI Mindset** | The Scrum Master facilitates the process so that stakeholders arrive at an aligned decision, rather than having one forced upon them. |
| **The Trap** | Adding more developers (Distractor 3) is rarely a quick fix and doesn't solve the underlying problem of misaligned priorities. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Mentoring leadership on Agile "Ways of Working" (protecting the team, formal feedback cycles) is essential for maintaining alignment and team productivity. |
| **PMI Mindset** | The PM acts as a shield for the team while educating stakeholders on how to interact with the team effectively. |
| **The Trap** | Providing "Real-time automated dashboards" (Distractor 1) often encourages micromanagement, which is the opposite of the desired agile mindset. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Personas are a key agile tool for categorizing and humanizing stakeholder groups, making it easier to identify and align with their expectations. |
| **PMI Mindset** | Understanding the user's perspective through personas leads to better feature prioritization and higher stakeholder satisfaction. |
| **The Trap** | A RACI matrix (Distractor 1) defines roles in a process but doesn't help the team understand the *expectations* or *needs* of the users themselves. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Acceptance Criteria are the primary agile tool for defining the "Definition of Done" for a specific feature, ensuring stakeholder expectations are explicit. |
| **PMI Mindset** | Clarity of expectations at the start of work prevents rework and ensures the team delivers what the stakeholder actually needs. |
| **The Trap** | Detailed functional specs (Distractor 2) are generally avoided in Agile in favor of iterative refinement and clear acceptance criteria. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Data-driven facilitation (using the Burndown chart) helps stakeholders see the consequences of their actions and aligns them with the established agile process. |
| **PMI Mindset** | The PM protects the team's commitment while educating stakeholders on the proper way to introduce new ideas (via the Product Backlog). |
| **The Trap** | Accepting the requests but moving others (Distractor 2) still disrupts the sprint flow and undermines the team's planning process. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In hybrid projects with distinct workstreams, grouping stakeholders by their specific area of interest/impact ensures more relevant and effective engagement. |
| **PMI Mindset** | Tailoring engagement to the stakeholder's specific needs and interests increases efficiency and reduces "Communication Noise." |
| **The Trap** | Sending the same update to everyone (Distractor 1) is a common failure that leads to stakeholders ignoring the communication because much of it is irrelevant to them. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | "Gated Funding" or "Incremental Funding" is a classic hybrid technique that satisfies the need for governance while allowing for agile flexibility. |
| **PMI Mindset** | The PM bridges the gap between different organizational cultures and expectations through creative governance structures. |
| **The Trap** | Maintaining two separate plans (Distractor 3) is unsustainable and creates a lack of transparency and coordination at the enterprise level. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Facilitating "Tailoring" allows for local constraints (like laws or culture) to be respected while still maintaining alignment with global project goals. |
| **PMI Mindset** | The PM must be culturally and contextually aware, finding flexible solutions that don't compromise the project's overall integrity. |
| **The Trap** | "Mandating" a single approach (Distractor 1 or 2) when there are legitimate local constraints is a recipe for resistance and failure. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Mentoring the PMO involves collaborative problem-solving to adapt governance tools to the new hybrid reality. |
| **PMI Mindset** | The PM should be a "Bridge Builder," helping the organization's governance structures evolve to support modern delivery methods. |
| **The Trap** | Hiding parts of the project (Distractor 3) is a violation of transparency and will eventually lead to major alignment issues. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | High-influence external groups require close management. The choice of communication method should be tailored to their specific mode of influence (Legal = formal/Push; Media = relationship/Interactive). |
| **PMI Mindset** | The PM recognizes that influence comes in many forms and adapts engagement strategies accordingly. |
| **The Trap** | "Monitoring" (Distractor 3) high-influence NGOs is dangerous and often leads to project delays due to unforeseen opposition. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Decision Log and Scope Statement are the authoritative records for why expectations were or were not met. Using them provides objective evidence for the PM's position. |
| **PMI Mindset** | Transparency and documentation are the PM's best tools for managing memory gaps and misalignments in expectations. |
| **The Trap** | Apologizing and adding it back (Distractor 1) without assessment undermines the project's governance and budget. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Facilitation involves turning vague complaints into measurable requirements (Success Criteria) that can be tracked and managed. |
| **PMI Mindset** | The PM uses phase transitions as an opportunity to realign expectations and improve project outcomes based on feedback. |
| **The Trap** | Simply documenting the disagreement (Distractor 3) without taking action fails to prevent the same problem in the next phase. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Mentoring "Upward" involves guiding senior stakeholders toward the information that is most relevant to their role, improving the efficiency of governance. |
| **PMI Mindset** | The PM should influence stakeholders to adopt engagement patterns that support project success. |
| **The Trap** | Giving the sponsor technical training (Distractor 1) is likely to be seen as patronizing and doesn't address the underlying need for executive-level summaries. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Peers and other PMs are "Sideward" stakeholders. Engagement should be collaborative and focused on mutual benefit since no direct authority exists. |
| **PMI Mindset** | Adapting communication style to the "Direction of Influence" ensures that the message is received in the right context. |
| **The Trap** | Using an "Upward" (Distractor 1) or "Downward" (Distractor 2) tone with peers can cause resentment and hinder collaboration. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Engagement Assessment Matrix is the specific tool used to identify and plan for closing the gap between a stakeholder's current and desired state. |
| **PMI Mindset** | Stakeholder management is a proactive process of shifting attitudes and behaviors through targeted engagement. |
| **The Trap** | While a Communication Matrix (Distractor 3) is related, it doesn't capture the "Attitude" or "State" of the stakeholder, only the logistics. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Facilitating alignment when expectations change requires an objective analysis of the impact on the "Triple Constraint" (Time, Cost, Scope/Quality/Risk). |
| **PMI Mindset** | The PM provides data-driven options to stakeholders rather than making unrealistic promises or flat refusals. |
| **The Trap** | Forcing the team to work double shifts (Distractor 1) without analysis is a reactive move that usually leads to burnout and quality issues. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Mentoring can involve "Social Proof." Seeing success and hearing from peers can be more effective at aligning expectations than logical arguments or authority. |
| **PMI Mindset** | The PM seeks creative ways to address the root cause of resistance (fear) and build trust. |
| **The Trap** | Using "Strategic Mandates" (Distractor 1) often increases resistance and creates a toxic project environment. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Personas allow the team to recognize and address distinct stakeholder expectations without having to compromise on a single, suboptimal solution. |
| **PMI Mindset** | Embracing diversity in stakeholder needs leads to more inclusive and successful product design. |
| **The Trap** | "Averaging out" (Distractor 2) often results in a product that satisfies nobody. |
| **Source Link** | guide/04-stakeholder/stakeholder-classification.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In Agile, "Face-to-Face" communication and the Product Owner are the primary sources for identifying and aligning with customer expectations in real-time. |
| **PMI Mindset** | Proactive clarification prevents "Waste" (rework) and ensures the team is always working on the right priorities. |
| **The Trap** | Waiting until the Sprint Review (Distractor 1) is a missed opportunity for early alignment and may lead to a wasted week of development. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | If the formal cycles (Sprint Reviews) are failing, increasing the frequency and informality of feedback loops (Mid-Sprint Demos) is the standard agile response to misalignment. |
| **PMI Mindset** | The PM should focus on building the relationship and improving the feedback mechanism rather than being defensive. |
| **The Trap** | Rigid user stories (Distractor 2) go against the agile principle of "Responding to Change" and can stifle innovation. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Mentoring functional managers on agile economics (Cost of Delay) helps them understand the value of providing resources and aligns their priorities with the project. |
| **PMI Mindset** | The PM should influence the organizational environment to support the project's chosen methodology. |
| **The Trap** | Making decisions without SMEs (Distractor 1) often leads to a product that doesn't meet the business needs, resulting in failure. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Collaborative "Visioning" tools (Vision Box, Vision Statement) are designed to categorize and align diverse stakeholder expectations into a single, cohesive goal. |
| **PMI Mindset** | Shared vision is the foundation of agile success and should be built through collaboration rather than authority. |
| **The Trap** | Using Power/Interest (Distractor 2) to pick a single "winner" ignores the value of consensus and can lead to long-term resistance from other stakeholders. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Agile metrics (Lead/Cycle Time) allow for "Probabilistic Forecasting," which aligns stakeholder expectations with the reality of a flow-based system. |
| **PMI Mindset** | The PM uses data to provide realistic transparency and manage expectations without making false promises. |
| **The Trap** | Telling a stakeholder "it's impossible to predict" (Distractor 2) is unprofessional and fails to use the tools available in the methodology. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The "Definition of Done" (DoD) is the primary tool for aligning global expectations (like security, quality, or compliance) with the team's work. |
| **PMI Mindset** | The PM looks for systemic solutions (updating the DoD) rather than blaming individuals or just fixing the symptom. |
| **The Trap** | Fixing it immediately (Distractor 2) without updating the DoD means the same mistake will likely happen again. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Mentoring "External" (to the team) stakeholders involves inviting them into the process so they can adapt their own "Ways of Working" to the new model. |
| **PMI Mindset** | The PM bridges the gap between different departments by creating opportunities for collaborative learning and process adaptation. |
| **The Trap** | Telling them to wait until the end (Distractor 1) creates a huge risk of late-stage failure and rework. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In hybrid projects with diverse sub-teams, an "Interface Agreement" (or Working Agreement) is essential for aligning expectations at the points where the methodologies meet. |
| **PMI Mindset** | The PM manages the "White Space" between different teams and methodologies to ensure a cohesive final product. |
| **The Trap** | Forcing them to follow the same rules (Distractor 2) ignores the legitimate reasons why they are using different methodologies in the first place. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The "Last Responsible Moment" is a key hybrid/lean concept for aligning agile flexibility with predictive constraints. |
| **PMI Mindset** | The PM identifies the critical dependencies and uses them to set realistic boundaries for all stakeholders. |
| **The Trap** | Forcing a decision too early (Distractor 1) limits the value of the agile approach, while ignoring the hardware constraint (Distractor 2) leads to project failure. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In any project, but especially hybrid ones, scope alignment during budget cuts should be driven by "Business Value" and ROI, not just by which methodology has more money left. |
| **PMI Mindset** | The PM acts as a business-minded advisor, helping the sponsor make the best decision for the organization's bottom line. |
| **The Trap** | Cutting the agile budget (Distractor 1) just because it has more money ignores the fact that those features might be the most valuable part of the project. |
| **Source Link** | guide/05-initiation/delivery-strategy.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Mentoring senior stakeholders involves providing clear, concise, and role-appropriate educational materials (the Executive Guide) to bridge the knowledge gap. |
| **PMI Mindset** | The PM is responsible for ensuring that all stakeholders have the information they need to perform their roles effectively. |
| **Source Link** | guide/04-stakeholder/communication-planning.md |
...
| :--- | :--- | :---: |
| **1. Categorize stakeholders** | 1, 5, 9, 12, 16, 20, 24, 27, 31, 35, 39, 43, 47 | 13 |
| **2. Identify stakeholder expectations** | 2, 6, 8, 13, 17, 21, 25, 28, 32, 36, 40, 44, 48 | 13 |
| **3. Facilitate discussions to align expectations** | 3, 7, 11, 14, 18, 22, 26, 29, 33, 37, 41, 45, 49 | 13 |
