# Process Task 3: Help ensure value-based delivery - Practice Exam
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Value-based delivery requires shifting focus from outputs (the bridge) to outcomes and benefits (reduced travel time). Identifying these components involves collaborative definition with stakeholders to ensure strategic alignment. |
| **PMI Mindset** | Value is not just the deliverable; it is the measurable improvement the deliverable creates for the organization or community. |
| **The Trap** | Focusing on technical specifications or milestones is an output-oriented mindset, which is a common mistake when value-based delivery is the objective. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | WSJF is a powerful agile prioritization tool that specifically addresses value, time criticality, and risk reduction (Cost of Delay) relative to the effort (Duration). |
| **PMI Mindset** | Economic prioritization ensures that the highest value is delivered as early as possible, maximizing ROI. |
| **The Trap** | Deferring to the highest-ranking stakeholder (HiPPO) or using technical complexity alone ignores the business value and cost of waiting. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | An MBI focuses on releasing the smallest piece of actual business value. This allows for early ROI and validation, even in large, complex projects. |
| **PMI Mindset** | Value should not be "big bang" at the end. PMs should look for ways to release value early to prove the concept and gain stakeholder buy-in. |
| **The Trap** | Showing documentation or screenshots is not the same as delivering working software that provides real utility. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Business Case is a living document. If external factors change the value proposition, the PM must re-validate the justification for the project's existence. |
| **PMI Mindset** | Projects that no longer deliver strategic value should be redirected or terminated. Sunk costs must be ignored. |
| **The Trap** | Continuing a project just because it is "on track" when the ultimate value is gone is a violation of the value-based delivery principle. |
| **Source Link** | `guide/05-initiation/business-case.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Benefits must be planned, measured, and owned. If strategic impact isn't visible, it's often because the link between technical outputs and business benefits hasn't been defined or measured. |
| **PMI Mindset** | Technical success does not equal business success. PMs must use leading indicators to predict whether long-term benefits will be realized. |
| **The Trap** | Velocity and defect rates are "output" or "efficiency" metrics, not "value" or "benefit" metrics. |
| **Source Link** | `guide/02-strategic/benefits-realization.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Kano Model helps balance time-to-market with customer satisfaction. Delivering "Basic Needs" quickly (the simple system) provides immediate value and learning. |
| **PMI Mindset** | Evaluating delivery options involves balancing speed-to-value with long-term strategic depth. |
| **The Trap** | Choosing the most complex option risks long delays with no value, while choosing the cheapest option might miss the strategic mark entirely. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Weighted scoring provides an objective, data-driven way to prioritize when resources are limited, ensuring that the most valuable work is preserved. |
| **PMI Mindset** | Value prioritization should be objective and aligned with the project's core objectives, not just stakeholder influence or cost. |
| **The Trap** | Relying on stakeholder power or simple cost-cutting ignores the underlying value proposition of the project. |
| **Source Link** | `guide/05-initiation/business-case.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | An MVP is designed for learning and risk reduction. By delivering the core value early, the team can validate assumptions before committing more resources. |
| **PMI Mindset** | In uncertain environments, delivering a small, functional increment for feedback is superior to building a large, unproven system. |
| **The Trap** | Building infrastructure first provides no visible value to users and delays the validation of the business model. |
| **Source Link** | `guide/02-strategic/benefits-value.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Benefits realization requires a metric, a baseline, a target, and an owner. Without these, the project cannot prove it achieved its strategic goals. |
| **PMI Mindset** | Verification of value delivery extends beyond technical "go-live" to the actual realization of the planned benefits in the operational environment. |
| **The Trap** | Testing and training are necessary for delivery (outputs/outcomes) but do not constitute a measurement system for benefits. |
| **Source Link** | `guide/02-strategic/benefits-realization.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | If the deliverable is not being adopted, the value is not being realized. The PM must investigate the "Outcome" (behavioral change) to ensure the "Benefit" (health) occurs. |
| **PMI Mindset** | Value is only realized through adoption and usage. A technically perfect output that is not used is a failure in value-based delivery. |
| **The Trap** | Focusing solely on engineering milestones or using mandates ignores the critical role of change management and stakeholder needs in value creation. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Value can be internal (risk reduction, cost avoidance). The PM's role is to bridge the gap between technical reality and business perception by using value-based language. |
| **PMI Mindset** | All work in the backlog should be justified by value. Technical debt reduction provides value through sustainability and risk mitigation. |
| **The Trap** | Ignoring technical debt leads to long-term failure, but forcing it without explaining the "why" leads to stakeholder conflict. |
| **Source Link** | `guide/02-strategic/benefits-value.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | While NPV is generally the "king" of metrics, organizational constraints (like cash flow) can make the payback period more critical for demonstrating immediate value. |
| **PMI Mindset** | Value must be evaluated within the context of the organization's current environment and constraints. |
| **The Trap** | Choosing NPV blindly without considering the company's survival (cash flow) is a common analytical error. |
| **Source Link** | `guide/05-initiation/business-case.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Delivering an increment of value (the city center data) early provides immediate benefit and allows for real-world testing of the dashboard with actual users. |
| **PMI Mindset** | Incremental delivery reduces the "time to value" and allows the organization to start realizing benefits before the project is 100% complete. |
| **The Trap** | "Big bang" releases at the end of long projects delay value and increase the risk that the final product won't meet user needs. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The gap between "Verified" (built right) and "Validated" (built the right thing) is where value is often lost. The PM must ensure the team understands the *outcome* desired. |
| **PMI Mindset** | Meeting acceptance criteria is not enough if the business value is not realized. Agile teams must pivot based on feedback to ensure value. |
| **The Trap** | Arguing that requirements were met (Verification) when the customer is unhappy (Validation failure) is a classic PMP trap. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Sunk costs should never influence future decisions. The only relevant comparison is the future cost of finishing the current path vs. the future cost and value of an alternative. |
| **PMI Mindset** | Professional and ethical responsibility includes advising against continuing projects that are no longer in the organization's best interest. |
| **The Trap** | The "Sunk Cost Fallacy" is a powerful psychological trap where people want to continue an investment simply because they have already put resources into it. |
| **Source Link** | `guide/05-initiation/business-case.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | OKRs and Balanced Scorecards are modern tools that help bridge the gap between team-level execution and organizational-level strategy. |
| **PMI Mindset** | Measurement systems must be integrated into the workflow to ensure that value is being tracked continuously, not just as an afterthought. |
| **The Trap** | Reporting velocity or cycle time only tracks efficiency, not whether the *right* outcomes are being achieved for the business. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In a hybrid environment, the PM must be creative in maintaining value delivery despite constraints. Simulating hardware allows for continued progress and early validation. |
| **PMI Mindset** | Value-based delivery involves adapting to changes in the environment to preserve the project's ultimate goals. |
| **The Trap** | Stopping work entirely is a reactive move that destroys value, while ignoring the hardware delay leads to integration failures later. |
| **Source Link** | `guide/02-strategic/benefits-value.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | ESG value is multi-dimensional. Identifying it requires engaging with all relevant stakeholder groups to ensure the project meets the broad definition of "Social" and "Governance" value. |
| **PMI Mindset** | Value is defined by stakeholders. The PM must facilitate the discovery of these definitions rather than imposing them. |
| **The Trap** | Focusing on only one group (like financial analysts) or the "easiest" tasks misses the strategic intent of an ESG-focused project. |
| **Source Link** | `guide/02-strategic/benefits-value.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | First-mover advantage and early validation are critical in competitive markets. Releasing an MBI (Minimum Business Increment) provides immediate value and market positioning. |
| **PMI Mindset** | Perfect is the enemy of good, especially when market windows are closing. Early delivery allows for faster learning and adaptation. |
| **The Trap** | Waiting for a "complete" product is a high-risk strategy that often results in missing the market entirely. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A pilot is a classic way to deliver incremental value and learn in large-scale infrastructure projects. It provides "proof of value" to the sponsor early. |
| **PMI Mindset** | Large projects should be broken down into smaller, manageable increments that provide measurable benefits. |
| **The Trap** | Building infrastructure or waiting for a national "switch-on" delays value and increases the risk of large-scale failures. |
| **Source Link** | `guide/02-strategic/benefits-value.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Benefits realization often requires post-project monitoring and adjustment. If benefits aren't appearing, the PM should look at adoption barriers or process changes. |
| **PMI Mindset** | Success is measured by the realization of benefits, not just the delivery of outputs. PMs must ensure a smooth transition to operations to sustain value. |
| **The Trap** | Assuming the job is done at "Go-Live" ignores the entire purpose of the project: creating business value. |
| **Source Link** | `guide/02-strategic/benefits-realization.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Agile teams must be able to "pivot" when value disappears. Continuing work on a feature with no value is a waste of resources, regardless of the effort already spent. |
| **PMI Mindset** | Value-based delivery requires ruthless prioritization. If value drops to zero, the work should stop. |
| **The Trap** | Finishing work just because it was started is another form of the Sunk Cost Fallacy. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Benefits mapping (or a value chain) helps stakeholders see how different technical outputs converge to create overarching organizational value. |
| **PMI Mindset** | Value is multi-faceted. The PM must integrate these different views into a coherent benefits realization plan. |
| **The Trap** | Prioritizing one group over others or splitting the project into fragments fails to capture the holistic value proposition. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The "Cost of Delay" is a critical factor. The COTS solution starts earning $200k/month nine months earlier than the in-house build, which more than covers its higher cost. |
| **PMI Mindset** | Evaluating delivery options requires looking at the "Net Value" (Benefits minus Costs) over time, including the impact of delivery speed. |
| **The Trap** | Focusing only on "Initial Cost" is a common mistake that ignores the revenue-generating potential of early delivery. |
| **Source Link** | `guide/05-initiation/business-case.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Stakeholders sometimes lose the "forest for the trees" in agile. The PM must periodically "zoom out" to show how the small increments are creating large-scale value. |
| **PMI Mindset** | Continuous communication of value is essential for maintaining stakeholder engagement and support in agile environments. |
| **The Trap** | Sharing more technical data or making features more complex doesn't address the stakeholders' fundamental need to see business impact. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When the "Cost" side of the value equation changes significantly, the PM must re-evaluate the entire "Net Value" proposition and seek sponsor guidance. |
| **PMI Mindset** | PMs are stewards of the organization's resources. They must ensure that the investment still makes sense when circumstances change. |
| **The Trap** | Hiding the cost increase or cutting quality both damage the long-term value of the project. |
| **Source Link** | `guide/05-initiation/business-case.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Delivering a simple "Quick Win" (Commuter Benefits) provides early value, reduces technical risk, and builds stakeholder confidence. |
| **PMI Mindset** | Incremental delivery involves balancing "High Value" with "Speed to Market" and "Technical Learning." |
| **The Trap** | Waiting for a "complete" package or only focusing on the hardest task increases the risk of early project failure. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A measurement system must be systematic and data-driven. Automated surveys provide the objective data needed to track benefits like NPS. |
| **PMI Mindset** | Benefit tracking must be planned and automated where possible to ensure consistency and reliability of the data. |
| **The Trap** | Relying on "anecdotal" evidence (like logs of positive comments) is not a robust measurement system for strategic benefits. |
| **Source Link** | `guide/02-strategic/benefits-realization.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Impact Mapping is a powerful agile technique for visualising how technical work connects to business goals, helping to define "value" in a concrete way. |
| **PMI Mindset** | PMs must provide clarity and alignment on what "value" actually means to ensure the team is working on the right things. |
| **The Trap** | Simple voting or technical excellence alone does not guarantee that the work is aligned with a strategic (if vague) business goal. |
| **Source Link** | `guide/02-strategic/benefits-value.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Value must be calculated over the relevant time horizon. The 5-year patent window is the constraint that dictates whether high automation costs can be recovered. |
| **PMI Mindset** | Value-based evaluation requires a holistic look at both capital expenditures (CapEx) and operating expenditures (OpEx) over the product's life. |
| **The Trap** | Choosing "automation" or "low risk" without doing the math is a non-analytical approach that ignores the actual value realization. |
| **Source Link** | `guide/05-initiation/business-case.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | SV and CV track project performance (efficiency). Value status tracks whether the project is still on path to deliver its promised benefits (effectiveness). |
| **PMI Mindset** | PMs must report on both "are we doing the work right?" (EVM) and "is the work still worth doing?" (Benefit tracking). |
| **The Trap** | Confusing project performance metrics with business value metrics is a common gap in predictive project reporting. |
| **Source Link** | `guide/02-strategic/benefits-realization.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Kano Model states that "Basic Needs" must be met first. No amount of "Delighters" can compensate for a product that doesn't work or isn't secure. |
| **PMI Mindset** | Value delivery requires a logical sequence. Building a foundation of stability and security is a prerequisite for higher-level value. |
| **The Trap** | Focusing on "exciting" features while ignoring "boring" but essential ones is a common recipe for project failure. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Releasing a completed module (Admissions) allows for early benefit realization (efficiency in the admissions process) and real-world testing. |
| **PMI Mindset** | PMs should look for "functional chunks" that can be released early to prove value, even if the larger system is still under construction. |
| **The Trap** | Waiting for the "whole" system increases the risk that the first module will be outdated or won't integrate well when finally launched. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Leading indicators (like adoption) are designed to provide early warnings. If the indicator is low, the PM must investigate the *cause* to save the long-term benefit. |
| **PMI Mindset** | Measuring value is pointless if the team doesn't act on the data. Agile is about inspecting and adapting based on real-world usage data. |
| **The Trap** | Assuming delivery equals value or simply working harder/faster are common reactive mistakes that don't solve the underlying value problem. |
| **Source Link** | `guide/02-strategic/benefits-realization.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Value-based delivery often involves balancing competing objectives. Protecting existing value (quality) is as important as creating new value (cost savings). |
| **PMI Mindset** | PMs must address stakeholder concerns by incorporating them into the project's value definition and measurement system. |
| **The Trap** | "Tunnel vision" on a single financial goal often leads to project failure through stakeholder resistance or unintended negative consequences. |
| **Source Link** | `guide/02-strategic/benefits-value.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Evaluating options requires a "Total Cost of Ownership" (TCO) and "Time to Value" analysis. The 3-sprint head start could provide massive value that outweighs the 2% fee. |
| **PMI Mindset** | Value delivery involves making economic trade-offs between speed, cost, and long-term operating expenses. |
| **The Trap** | Favoring "No Fees" (Low OpEx) without considering the "Cost of Delay" (High Opportunity Cost) is a classic narrow-minded business mistake. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Using a "Data Spike" or a subset of data allows the agile team to start delivering value (insights) and learning while the larger infrastructure work continues. |
| **PMI Mindset** | Hybrid projects should look for ways to decouple work streams so that value can be delivered in parallel rather than in strict sequence. |
| **The Trap** | Sequential "Waterfall-style" thinking in a hybrid project often results in long periods with no value delivery. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Value is defined by organizational strategy. When strategy shifts (e.g., due to a merger), the PM must proactively realign the project to remain valuable. |
| **PMI Mindset** | PMs must be adaptable and focused on current organizational needs, not just historical agreements. |
| **The Trap** | Following an outdated plan or trying to "do everything" with limited resources both lead to poor value delivery. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Examining business value involves looking at the *distribution* of value. Optimization of existing results is often the best way to maximize value with limited remaining time. |
| **PMI Mindset** | PMs should use data to guide the team's final efforts toward the highest possible ROI. |
| **The Trap** | Blindly asking for more time or ignoring the "Value Gap" both fail to maximize the outcome of the current project. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A measurement system must track the actual benefit (wait times), not just the outputs (uptime) or the inputs (training/budget). |
| **PMI Mindset** | Measuring the right thing is as important as measuring correctly. Benefits realization tracking must focus on the strategic goals. |
| **The Trap** | Technical performance metrics (uptime) are often mistaken for business value metrics (wait times). |
| **Source Link** | `guide/02-strategic/benefits-realization.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In the modern PMP context, value is more than just profit. Strategic alignment (like ESG) can override short-term financial gains if that is the organization's focus. |
| **PMI Mindset** | PMs must look at the "Triple Bottom Line" (People, Planet, Profit) when evaluating value delivery. |
| **The Trap** | Assuming profit is always the "correct" answer ignores the strategic context of the project. |
| **Source Link** | `guide/02-strategic/benefits-value.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | This is a "Cost of Delay" calculation. Option B costs $500k more but brings in $600k more in revenue during the first year, resulting in a $100k net advantage. |
| **PMI Mindset** | Value-based delivery requires an economic mindset that considers the impact of time on the total net benefit of the project. |
| **The Trap** | Looking only at the construction cost (CapEx) ignores the massive value of early market entry or operational start. |
| **Source Link** | `guide/05-initiation/business-case.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Delivering an increment that is "better than the current state" provides immediate value. It doesn't have to be "perfect" to be "valuable." |
| **PMI Mindset** | Incremental delivery allows the organization to start capturing benefits earlier and provides real-world data to improve the final product. |
| **The Trap** | The "all-or-nothing" mindset in software development delays value and ignores the opportunity to help users with partial solutions. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | External changes (like subsidies) can radically change the value of different project components. The PM must examine these changes to ensure the project remains optimized for value. |
| **PMI Mindset** | Examining business value means being proactive in responding to the environment to ensure the organization's investment remains as high-value as possible. |
| **The Trap** | "Plan rigidity" (sticking to the original plan despite changes) is a major cause of lost value in projects. |
| **Source Link** | `guide/05-initiation/business-case.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Since many benefits are "Lagging," the PM must ensure that someone in operations (the Benefit Owner) has the plan and the tools to track them after the project team is gone. |
| **PMI Mindset** | Sustainment is a critical part of the benefits lifecycle. The PM's role is to enable the *long-term* realization of value. |
| **The Trap** | Mistaking "Project Performance" (under budget) for "Project Benefit" (lower healthcare costs) is a common failure in value-based reporting. |
| **Source Link** | `guide/02-strategic/benefits-realization.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Value is often multi-dimensional. Capturing all relevant dimensions (efficiency and risk reduction) ensures the project's full "worth" is understood and measured. |
| **PMI Mindset** | PMs should use a "Holistic" view of value that includes both tangible (time) and intangible or risk-based (accuracy) benefits. |
| **The Trap** | Oversimplifying value into a single metric often misses the true strategic justification for the project. |
| **Source Link** | `guide/02-strategic/benefits-value.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | This is a "Time to Value" analysis. Option 1 provides $3,000 in net value ($1k x 3 months) during the time Option 2 is still being built. The long-term advantage of Option 2 only starts *after* that gap is closed. |
| **PMI Mindset** | Delivering value *now* is often superior to delivering slightly more value *later*, especially in fast-moving environments. |
| **The Trap** | Focusing on "Zero Cost" (Option 2) ignores the massive "Opportunity Cost" of not having the tool operational for three months. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Breaking down a complex feature (Search) into a simple version (Keyword Search) provides immediate value to the user while the more advanced parts are built. |
| **PMI Mindset** | Value-based delivery is about finding the smallest "slice" of functionality that provides actual utility to the end user. |
| **The Trap** | Doing the "easiest" work (Shopping Cart) or the "hardest" work (Full Search) without considering the user's most urgent need (Finding products) is a failure of value prioritization. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Value is not just about direct profit. Risk mitigation, cost avoidance, and social responsibility are all valid and critical forms of value that a PM must be able to articulate. |
| **PMI Mindset** | PMs must advocate for the holistic value of their projects, especially when that value is not purely financial. |
| **The Trap** | Relying only on the "Initial ROI" figure without considering "Cost Avoidance" or "Intangible Benefits" is an incomplete way to measure value. |
| **Source Link** | `guide/02-strategic/benefits-value.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The entire purpose of an MVP is to learn. If the learning is "it's too hard to use," the PM must facilitate a decision on whether the value is still reachable through a "Pivot" or if the project should stop. |
| **PMI Mindset** | Agile project management is about making data-driven decisions at key "Value Gates" (like an MVP release) to ensure the organization's money is being well spent. |
| **The Trap** | Ignoring the "Learning" from the MVP and just pushing forward with the original plan is a waste of the 25% remaining budget. |
| **Source Link** | `guide/08-execution/value-delivery.md` |
...
| :--- | :--- | :--- | :--- |
| 1 | 1 | Predictive | Strategic Alignment vs Outputs |
| 2 | 2 | Agile | WSJF Prioritization |
| 3 | 3 | Hybrid | Minimum Business Increment (MBI) |
| 4 | 4 | Predictive | Business Case Re-validation |
| 5 | 5 | Agile | Leading vs Lagging Indicators |
| 6 | 6 | Hybrid | Kano Model for Delivery Options |
| 7 | 2 | Predictive | Multi-criteria Decision Analysis |
| 8 | 3 | Agile | Minimum Viable Product (MVP) |
| 9 | 5 | Predictive | Benefits Realization Plan Components |
| 10 | 4 | Hybrid | Adoption Barriers & Value |
| 11 | 1 | Agile | Technical Debt as Business Value |
| 12 | 6 | Predictive | Payback Period vs NPV in Constraints |
| 13 | 3 | Hybrid | Incremental Release of Functional Chunks |
| 14 | 2 | Agile | Verification vs Validation |
| 15 | 4 | Predictive | Sunk Cost Fallacy |
| 16 | 5 | Agile | OKRs and Strategic Alignment |
| 17 | 2 | Hybrid | Maintaining Value during Disruption |
| 18 | 1 | Predictive | ESG Value Identification |
| 19 | 6 | Agile | Time to Market & Market Windows |
| 20 | 3 | Hybrid | Piloting for Early Value & Learning |
| 21 | 5 | Predictive | Post-Implementation Review |
| 22 | 2 | Agile | Pivoting when Value Drops |
| 23 | 1 | Hybrid | Benefits Mapping / Value Chain |
| 24 | 6 | Predictive | Cost of Delay (In-house vs COTS) |
| 25 | 4 | Agile | Cumulative Value Visualization |
| 26 | 2 | Hybrid | ROI Re-evaluation under Cost Change |
| 27 | 3 | Agile | Quick Wins vs High-value Complexity |
| 28 | 5 | Predictive | Systematic Measurement (NPS) |
| 29 | 1 | Agile | Impact Mapping |
| 30 | 6 | Hybrid | Lifecycle Cost Analysis (CapEx/OpEx) |
| 31 | 4 | Predictive | Value Status Reporting |
| 32 | 2 | Agile | Kano: Basic Needs vs Delighters |
| 33 | 3 | Hybrid | Soft Launch for Early Benefits |
| 34 | 5 | Agile | Acting on Leading Indicators |
| 35 | 1 | Predictive | Protecting Existing Value (Quality) |
| 36 | 6 | Agile | TCO & Speed Trade-offs |
| 37 | 3 | Hybrid | Data Spikes for Incremental Insights |
| 38 | 2 | Predictive | Strategic Realignment (Mergers) |
| 39 | 4 | Agile | Optimizing for the "Value Gap" |
| 40 | 5 | Hybrid | Measuring the Right Metric (Benefits) |
| 41 | 2 | Agile | Ethical Growth (ESG) Prioritization |
| 42 | 6 | Predictive | Early Operational Start Value |
| 43 | 3 | Agile | "Better than Current" Increments |
| 44 | 4 | Hybrid | Scenario Analysis for Subsidies |
| 45 | 5 | Predictive | Benefits Sustainment Plan |
| 46 | 1 | Agile | Multi-dimensional Value (Time/Risk) |
| 47 | 6 | Hybrid | Net Value (Savings - Cost) Analysis |
| 48 | 3 | Agile | Feature Slicing (Simple vs Advanced) |
| 49 | 2 | Predictive | Cost Avoidance as Value |
