# Business Task 1: Define and Establish Project Governance - 50 Question Practice Exam
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Laws and regulations (EEF external) always trump organizational policies (OPA internal). When a conflict exists, the organization must adapt its policies to comply with legal requirements. The project manager must ensure compliance rather than making unilateral decisions. |
| **PMI Mindset** | Compliance is non-negotiable. The PM acts as a compliance advocate, not a decision-maker on regulatory interpretation. Legal/compliance has authority here. |
| **The Trap** | Following internal OPA seems logical from a governance perspective, but fails when the law requires otherwise. This is a common exam pattern where the "organization's way" conflicts with legal requirements. |
| **Source Link** | `guide/02-strategic/compliance-governance.md` - Compliance vs. Standards vs. Policy hierarchy |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Success criteria defined in the charter are governance guardrails. When they need modification, it's not a simple change control issue—it requires governance body (steering committee) approval because the business case that justified the project has changed. |
| **PMI Mindset** | The PM manages within approved tolerances. Changes that affect the business justification and strategic value require governance escalation, not just documentation or unilateral adjustment. |
| **The Trap** | Accepting sponsor approval alone seems reasonable, but when success criteria tied to the business case change, the governance body that approved the business case must be involved. |
| **Source Link** | `guide/05-initiation/project-charter.md` - Measurable Success Criteria and PM Authority Levels |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In Agile governance, system demos and sprint reviews serve as governance checkpoints. Regulatory requirements discovered mid-execution indicate a gap in compliance identification during initiation. The Scrum Master facilitates process improvement. |
| **PMI Mindset** | Agile governance focuses on empirical process control and continuous improvement. The issue isn't the removed features—it's why a regulatory requirement wasn't identified earlier in the process. |
| **The Trap** | Immediately removing the features seems action-oriented, but fails to address the governance gap. The real issue is process failure in compliance identification, not the scope change itself. |
| **Source Link** | `guide/02-strategic/compliance-governance.md` - Agile Governance (Adaptive Oversight) |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When multiple governance frameworks conflict, the organizational PMO provides the authoritative guidance on methodology tailoring. The PMO exists specifically to resolve these types of cross-project governance questions. |
...
| **The Trap** | Choosing one department's framework seems pragmatic, but creates governance risk. The PMO is designed to provide consistency across the organization. |
| **Source Link** | `guide/02-strategic/pmo-role.md` - PMO Types and Methodology (Tailoring) Services |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Hybrid governance balances strategic oversight with team autonomy. The PMO can serve as a servant leader by using existing artifacts (sprint reports, burndown charts) to satisfy governance needs without adding overhead. |
| **PMI Mindset** | The PM acts as a facilitator who finds solutions that satisfy both governance requirements and team efficiency. This is servant leadership in action—removing impediments while maintaining compliance. |
| **The Trap** | Pushing back on behalf of the team seems to support Agile values, but ignores the governance body's legitimate need for visibility. Automation is the win-win solution. |
| **Source Link** | `guide/02-strategic/pmo-role.md` - PMO as Servant Leader and AI-Enabled PMO services |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Safety is non-negotiable and supersedes all other project objectives. When "zero safety incidents" is a success criterion in the charter, any safety violation—near-miss or actual—triggers immediate corrective action regardless of schedule impact. |
| **PMI Mindset** | Safety and legal compliance always win. The PM doesn't trade safety for schedule. A near-miss is a warning that requires systemic correction, not just documentation. |
| **The Trap** | "Increased oversight" seems like a reasonable middle ground, but fails to address the root cause. The choice to stop work is not optional when safety success criteria are at risk. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Procurement policies exist to ensure fair competition and prevent fraud. Circumventing them by splitting contracts violates PMI's ethical value of honesty and fairness. The proper path is a formal waiver with documented justification. |
| **PMI Mindset** | Ethical compliance is non-negotiable. The PMI code of ethics requires honesty and fairness. When a policy conflicts with project needs, follow the proper exception process rather than subverting the control. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | WIP limits in Kanban are a governance mechanism established by the team for flow control. Changing them requires understanding the systemic impact. The Scrum Master's role is to educate stakeholders on the consequences of changing governance parameters. |
| **PMI Mindset** | In Agile, teams self-organize within strategic guardrails. The Scrum Master facilitates understanding between the product owner and team rather than making unilateral decisions or escalating prematurely. |
| **The Trap** | Increasing WIP limits seems responsive to business needs, but actually reduces flow efficiency and predictability—the opposite of what the product owner wants. |
| **Source Link** | `guide/02-strategic/compliance-governance.md` - Agile Governance Principles and Trust-Based approach |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Success criteria must be measurable AND owned. When success extends beyond project closure (like adoption rates), governance must assign post-project ownership. The charter should have specified who was responsible for driving adoption. |
| **PMI Mindset** | Value delivery requires end-to-end ownership. A project can't be declared successful if benefits weren't realized because no one was assigned to realize them. |
| **The Trap** | Requesting marketing budget seems solution-oriented, but the root cause is governance failure—no one was assigned responsibility for the adoption metric. |
| **Source Link** | `guide/02-strategic/pmo-role.md` - Benefits Tracking service and Value-Driven PMO |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | New laws apply immediately to all active projects regardless of when they were initiated. The charter sets overall guardrails, but the execution plan (quality management plan) must adapt to new legal requirements. The PMO should also be informed of the template gap. |
| **PMI Mindset** | Regulatory compliance is immediate and non-negotiable. The PM doesn't wait for governance artifacts to catch up—they implement requirements and help improve organizational process assets. |
| **The Trap** | Waiting for the PMO to update templates seems procedural, but delays necessary compliance work. The project must comply now while helping the organization improve. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Governance escalation paths and thresholds exist for transparency and early intervention. Verbal approvals bypass governance mechanisms designed to protect the organization. The charter's escalation procedures should be followed as written. |
| **PMI Mindset** | Governance requires documented trails and accountability. Verbal approvals create audit gaps and risk. The PM follows the established governance process even when a sponsor offers flexibility. |
| **The Trap** | Seeking written confirmation seems like a reasonable compromise, but the issue is that escalation thresholds were exceeded—governance requires visibility, not just post-facto documentation. |
| **Source Link** | `guide/05-initiation/project-charter.md` - PM Authority Levels and Escalation procedures |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Agile governance requires clear product vision and success criteria. When the Product Owner hasn't defined what "done" looks like for regulatory approval, the Scrum Master facilitates definition of MVP and dependencies rather than allowing arbitrary prioritization. |
| **PMI Mindset** | The Scrum Master serves the team by removing impediments to planning. Lack of prioritization is a governance gap that prevents the team from executing effectively. |
| **The Trap** | Starting with smallest features seems pragmatic for velocity, but building the wrong features wastes effort. Governance requires understanding what's actually needed for success. |
| **Source Link** | `guide/05-initiation/project-charter.md` - Agile Chartering and Vision Statement |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Approval authority exists for decentralized decision-making, but cumulative impacts that fundamentally change the project baseline require governance review. The "death by a thousand cuts" pattern undermines governance intent. |
| **PMI Mindset** | Governance is about intent as well as rules. The PM exercises judgment when individual actions, while technically compliant, collectively violate the spirit of governance controls. |
| **The Trap** | Continuing within individual authority limits seems technically correct, but ignores that governance bodies deserve visibility into cumulative impacts that change the project's nature. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Escalation thresholds should be interpreted broadly, not literally. When the recovery method impacts other baselines (budget contingency), the governance intent—protecting the overall project—is triggered. Escalation provides visibility into trade-offs. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Measurable success criteria are a governance foundation. "Reduce call volume by 30%" seems specific but actually allows ambiguity in measurement method. Good governance defines exactly what will be measured and how. |
| **PMI Mindset** | Success criteria must be unambiguous to prevent gaming or misinterpretation. SMART criteria (Specific, Measurable, Achievable, Relevant, Time-bound) require specifying the measurement method. |
| **The Trap** | Focusing on who was involved (operations) or reporting frequency misses the root cause—the charter itself allowed ambiguous interpretation of success. |
| **Source Link** | `guide/05-initiation/project-charter.md` - Measurable Success Criteria section |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Regulatory interpretation is not within a Scrum team's or product owner's authority. When compliance questions arise, the proper governance action is to pause and seek authoritative guidance from legal/compliance. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | PM authority in the charter typically references budget thresholds, but contractual obligations represent external governance that exceeds the PM's approval authority. Missing contractual deadlines triggers penalties and legal implications beyond project-level decision-making. |
| **PMI Mindset** | The PM manages within the project's governance envelope. External commitments (contracts) create governance obligations that exceed the PM's authority and require escalation. |
| **The Trap** **Focusing only on the budget threshold ($25,000 is under $50,000) misses that the schedule impact triggers contractual consequences beyond the PM's authority.** |
| **Source Link** | `guide/05-initiation/project-charter.md` - PM Authority Levels section |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Stage gates are governance checkpoints where requirements can be added based on evolving understanding. The gate committee has authority to impose new constraints. The PM's role is to implement, not challenge, legitimate governance decisions. |
| **PMI Mindset** | Governance is dynamic, not static. Stage gates exist specifically to allow course correction based on new information. The PM adapts rather than resisting governance decisions. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When multiple jurisdictions apply, governance must satisfy the strictest requirements across all. PMO templates provide a starting point but may need legal tailoring for specific contexts. Legal/compliance has authority for interpretation. |
| **PMI Mindset** | Templates are guidance, not substitutes for compliance judgment. When standard OPAs don't fit the situation, seek authoritative interpretation rather than improvising or selectively applying. |
| **The Trap** **Following the PMO template seems compliant, but GDPR may not be the strictest requirement for all data types in the project.** |
| **Source Link** | `guide/02-strategic/compliance-governance.md` - Data Privacy & AI and Key Regulations Reference Table |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Velocity is a governance metric for forecasting delivery capacity. Spikes (research) don't deliver customer value and shouldn't be counted in velocity. The Scrum Master coaches stakeholders on proper metrics rather than gaming the system. |
| **PMI Mindset** | Governance metrics should measure what they intend to measure. When metrics are misused, the solution is education, not manipulation or escalation. The Scrum Master serves as a process coach. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Success criteria must be achievable. When a criterion (ISO certification in 9 months) is factually impossible, continuing with an unrealistic goal sets the project up for failure. The governance body (steering committee) must reassess. |
...
| **The Trap** **Extending the timeline seems like a solution, but the PM doesn't have authority to change the charter's timeline without governance approval.** |
| **Source Link** | `guide/05-initiation/project-charter.md` - Measurable Success Criteria and Charter constraints |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Charter authority ambiguity is a governance gap. Rather than interpreting the charter unilaterally or escalating punitively, the PM works collaboratively to clarify governance. Resource allocation conflicts are common and require clear rules of engagement. |
...
| **Source Link** | `guide/05-initiation/project-charter.md` - PM Authority Levels and Resource Commitment |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The retroactive rule means new regulations apply immediately regardless of charter timing. The PM's role is to assess impact and present options to the governance body, not debate whether the charter requires compliance. |
| **PMI Mindset** | The PM provides information and recommendations to governance bodies, not decisions about whether to comply. The steering committee decides based on the impact assessment. |
| **The Trap** **Arguing that the charter doesn't require compliance misses the point that law trumps charter—compliance is mandatory regardless of what the document says.** |
| **Source Link** | `guide/02-strategic/compliance-governance.md` - The Retroactive Rule warning box |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Compliance concerns require authoritative input, not team or product owner judgment. The Scrum Master facilitates a conversation between the product owner (business need) and compliance/legal (constraints) to find a compliant solution. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | PMI's ethical value of honesty requires following organizational policies on gifts and vendor relationships. Accepting prohibited gifts violates ethics regardless of disclosure, sharing, or donation. The correct action is return, not rationalization. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Governance thresholds exist for transparency and oversight, not just risk management. Significant scope changes—whether positive or negative—deserve governance visibility. The threshold is about impact magnitude, not impact direction. |
| **PMI Mindset** | The PM provides transparency to governance bodies even when news is good. Oversight isn't just about catching problems—it's about understanding project evolution. |
| **The Trap** **Treating positive impacts differently seems pragmatic, but governance bodies deserve visibility into all significant changes to project baselines.** |
| **Source Link** | `guide/05-initiation/project-charter.md` - PM Authority Levels and Escalation procedures |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Success criteria must be accurate. When a criterion becomes factually impossible through no fault of the project, maintaining it in the charter misleads stakeholders and sets up failure. The charter must reflect reality. |
| **PMI Mindset** | The PM ensures project documentation accurately represents reality. Continuing with an unachievable success criterion violates honest communication. |
| **The Trap** **Arguing that "the project is compliant" misses that organizational certification is a prerequisite that no longer exists.** |
| **Source Link** | `guide/05-initiation/project-charter.md` - Measurable Success Criteria must be achievable |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Certification requirements are constraints on how work is done, not negotiable features. SOC 2 Type II requires demonstrating consistent security practices, which means building security in from the start, not "testing it in later." |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Governance thresholds exist for oversight, not to be technically navigated around. Consistently approving at $14,500 when the limit is $15,000 suggests exploiting the threshold rather than respecting its intent. |
| **PMI Mindset** | The PM follows the spirit of governance, not just the letter. Consistent patterns just under thresholds signal avoidance of oversight rather than legitimate decentralized decision-making. |
...
| **Source Link** | `guide/02-strategic/pmo-role.md` - PMO Types (Controlling) and audit services |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Success criteria that extend beyond project execution require assigned ownership for achievement and measurement. Without specifying who is responsible for post-launch metrics, the criteria is unenforceable. |
...
| **The Trap** **Focusing on escalation misses that no one was actually assigned responsibility for the NPS system—it fell through the cracks of poor governance design.** |
| **Source Link** | `guide/02-strategic/pmo-role.md` - Benefits Tracking service |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Regulatory compliance in high-stakes domains (pharmaceuticals) is non-negotiable. The PM doesn't have authority to approve deviations from regulatory requirements, regardless of scientific opinion or steering committee input. |
...
| **Source Link** | `guide/02-strategic/compliance-governance.md` - Compliance hierarchy and laws taking precedence |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Data privacy compliance requires legal interpretation of terms and consent. The product owner and team don't have authority to determine whether implicit consent is sufficient—legal does. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Success criteria must include measurement methodology. "Reduce by 25%" is meaningless without defining how the baseline and reduction are calculated. Governance failure occurred at charter creation by not specifying measurement approach. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Directive PMOs have authority over reporting standards, but the PM can suggest improvements to templates that don't fit current methodologies. Working with the PMO to improve the template serves both governance compliance and project needs. |
...
| **Source Link** | `guide/02-strategic/pmo-role.md` - Directive PMO characteristics and PMO Services |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The charter grants approval authority for a reason—decentralized decision-making. If the change meets the criteria (under 2 weeks), the PM should exercise their granted authority rather than escalating or rejecting based on a stakeholder preference. |
...
| **The Trap** **Escalating seems cautious, but undermines the point of granting PM authority in the first place. The charter established thresholds for decentralized decision-making.** |
| **Source Link** | `guide/05-initiation/project-charter.md` - PM Authority Levels section |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | PCI DSS compliance is non-negotiable for payment processing. Storing card data improperly creates legal liability. This is a stop-work situation, not a prioritization decision. Compliance violations are corrected immediately, not scheduled. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Conflicts of interest must be actively managed, not just disclosed. PMI's ethical value of fairness requires that team members with conflicts recuse themselves from related decisions. Disclosure alone is insufficient. |
...
| **Source Link** | `guide/02-strategic/compliance-governance.md` - Conflict of Interest ethical scenario |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Exceeding the total budget (including contingency) is a baseline change that requires governance approval. Re-baselining is a steering committee decision, not a PM action. The PM presents options and lets governance decide. |
| **PMI Mindset** | The PM manages within the authorized budget envelope. When that envelope is exceeded, the governance body that authorized the budget must decide how to proceed. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Success criteria should be measurable and meaningful, but governance bodies must consider context when evaluating results. External factors beyond project control may warrant reassessment of whether the criterion fairly measures success. |
...
| **Source Link** | `guide/02-strategic/pmo-role.md` - Benefits Tracking and value-driven governance |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Retroactive privacy policy changes may be illegal under GDPR, CCPA, and other regulations. The product owner and team don't have authority to determine permissibility—legal does. The Scrum Master facilitates legal review. |
| **PMI Mindset** | Privacy compliance is non-negotiable. The PM/Scrum Master doesn't make decisions about regulatory permissibility—legal does. |
| **The Trap** **Blocking the feature seems protective of users, but the question is legal (is this allowed?), not ethical (should we do this?).** |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Proactive compliance planning is more efficient than reactive correction. Even though the regulation doesn't apply immediately, updating the plan now ensures compliance when the time comes and prevents rework. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When success criteria are poorly defined (story count vs. value), the governance body should assess actual outcomes. The PM provides transparent information on both the stated metric (story count) and the arguably better metric (value). |
| **PMI Mindset** | The PM provides transparency to governance bodies rather than making unilateral decisions about whether poorly-written criteria should be enforced or reinterpreted. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Kickbacks and bribery are absolute ethical violations regardless of whether they're paid to the company or the individual. PMI's ethical values of honesty and fairness require declining and reporting such solicitations. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Critical security vulnerabilities are stop-work issues regardless of sprint commitments. Known vulnerabilities create immediate liability. The team stops using the vulnerable component now rather than planning to fix it later. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Approval authority is based on informed decision-making. If the estimate appears artificially low to bypass thresholds, the PM requires better information rather than approving a questionable estimate or escalating prematurely. |
...
| **Source Link** | `guide/05-initiation/project-charter.md` - PM Authority Levels |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Controlling PMOs mandate specific templates, but most templates include flexibility (custom fields, notes) for project-specific needs. The PM works within the required framework rather than creating parallel systems or seeking exemptions. |
...
| **Source Link** | `guide/02-strategic/pmo-role.md` - Controlling PMO characteristics |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** **Major strategic decisions like switching vendors mid-project are governance decisions, not PM decisions. The PM provides analysis and recommendations, but the steering committee decides whether to continue or pivot.** |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** **Dark pattern regulations are legal compliance issues, not just ethical concerns. The product owner and team don't have authority to determine compliance—legal does. The Scrum Master facilitates legal review.** |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** **Success criteria in the charter must be measurable to enable governance assessment. "High quality" and "satisfied stakeholders" are subjective and unmeasurable. The PM advocates for specific metrics even when the sponsor prefers vagueness.** |
| **PMI Mindset** **The PM ensures project artifacts are fit for purpose. Unmeasurable success criteria undermine governance and prevent objective assessment of project success.** |
| **The Trap** **Accepting vague criteria seems respectful of sponsor authority, but creates governance failure—success can't be objectively assessed.** |
| **Source Link** | `guide/05-initiation/project-charter.md` - Measurable Success Criteria and Signs of a Weak Charter |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** **Governance cadence should adapt to project needs. Complex phases may benefit from additional oversight. Requesting more reviews with clear rationale demonstrates good governance judgment, not weakness.** |
...
## Key Takeaways: Governance Pro-Tips

### 1. The Hierarchy Rule
**Laws > Standards > Policies > Guidelines.** When conflicts occur, laws and regulations always win. Never trade compliance for schedule, cost, or scope. If a new regulation passes mid-project, you must adopt it immediately—the "retroactive rule."

### 2. Authority Has Boundaries
PM authority defined in the charter is real authority, but it has limits. Budget thresholds don't give you license to ignore cumulative impacts. Contractual deadlines exceed PM approval authority. Compliance questions require legal input, not PM judgment.

### 3. Ambiguity Is a Governance Gap
Vague success criteria like "satisfied stakeholders" or "high quality" aren't criteria at all—they're wishful thinking. Push for specific, measurable metrics in the charter. If measurement method is ambiguous, the criterion itself is ambiguous.

### 4. Stop Work Isn't Optional
...
Requesting additional governance reviews when complexity increases is good judgment, not weakness. Escalating when you don't know the answer is professional, not incompetent. Governance exists to provide visibility—use it.

### 7. Ethics Are Absolute
Conflicts of interest require recusal, not just disclosure. Gifts exceeding policy limits are returned, not shared or donated. Kickbacks are reported, not quietly declined. PMI's four values—Responsibility, Respect, Fairness, Honesty—aren't situational.
