# Process Task 7 Practice Exam: Plan and Optimize Quality
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Prevention costs (like prototyping) are almost always lower than the cost of non-conformance. Reducing these upfront investments typically leads to much higher failure costs later. |
| **PMI Mindset** | Prevention over inspection. The PM must advocate for quality and explain the long-term cost benefits of prevention. |
| **The Trap** | The idea of increasing inspections later is tempting but reactive; it's an appraisal cost that doesn't fix the underlying risk of poor design that prototypes would catch. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | If the product meets specifications (acceptance criteria) but fails on "fitness for use" or overall quality perception, the Definition of Done (DoD) needs to be strengthened. |
| **PMI Mindset** | Continuous improvement (Kaizen). Use the retrospective to improve the process and standards for the whole team. |
| **The Trap** | Adding a separate story is a reactive way to handle a systemic quality issue. The goal is to build quality into every story via the DoD. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When a complex problem occurs across different components or teams, the PM must find the root cause of the interaction issue, not just assign blame. |
| **PMI Mindset** | Focus on problem-solving and root cause analysis. A fishbone diagram helps categorize potential causes across man, machine, method, etc. |
| **The Trap** | Auditing to find fault is a negative, reactive approach that doesn't solve the technical incompatibility. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The "Rule of Seven" states that seven or more consecutive points on one side of the mean indicate that the process is out of control and requires investigation for a special cause. |
| **PMI Mindset** | Data-driven decision making. Even if points are within limits, patterns can signal that the process is no longer stable. |
| **The Trap** | It's easy to assume that "within limits" means "everything is fine," but statistical patterns are just as important as the limits themselves. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Regulatory compliance is a non-negotiable quality requirement. In Agile, these should be prioritized in the backlog and built into the DoD. |
| **PMI Mindset** | Compliance and quality are integrated into the work, not treated as an afterthought or a separate phase. |
| **The Trap** | Using a formal CCB is a predictive process; in Agile, the backlog is the primary vehicle for all requirements, including compliance. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Quality must be defined by the customer/stakeholders through measurable metrics. Ambiguity must be resolved during planning to avoid failure. |
| **PMI Mindset** | Proactive requirement gathering and definition. You cannot manage quality if you haven't defined what "good" looks like. |
| **The Trap** | Simply picking the "tightest" spec might lead to unnecessary costs (over-engineering/high grade) that the customer didn't ask for. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Manage Quality (QA) involves audits to ensure that the project is following organizational and project-specific processes. This is distinct from the team-focused improvement of retrospectives. |
| **PMI Mindset** | Understanding the different purposes of quality processes. QA is about ensuring the "right processes" are used, which is a management/governance responsibility. |
| **The Trap** | While retrospectives are great for improvement, they are not a substitute for objective process audits in a hybrid or regulated environment. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When a deliverable fails to meet a quality requirement, the PM must assess the impact and involve the appropriate authority (sponsor) for trade-off decisions involving time, cost, and quality. |
| **PMI Mindset** | Transparent reporting and involving the sponsor in major trade-off decisions. Quality failures cannot be hidden or unilaterally "accepted" by the PM. |
| **The Trap** | Automatically starting rework without consulting the sponsor is a mistake, as the sponsor might value the schedule more than that specific 10% variance. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Continuous improvement and maintaining technical excellence are key to agile quality. Refactoring should be a regular part of the team's work. |
| **PMI Mindset** | Sustainable development. Technical debt is a quality issue that must be managed proactively as part of the normal flow of work. |
| **The Trap** | "Stop everything" is rarely a viable business option. The best approach is a balanced, continuous effort to maintain quality. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A negative correlation on a scatter diagram means that as one variable increases (review hours), the other decreases (defects found in testing). This validates the effectiveness of the prevention/appraisal activity. |
| **PMI Mindset** | Using quality tools to analyze data and validate process improvements. This confirms that "shifting left" is working. |
| **The Trap** | Misinterpreting "negative" correlation as a "bad" result. In this context, a negative correlation is exactly what is desired. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When a process deviation is found (QA), the first step is to correct the process (use the right plan) and then assess the damage/impact (QC) on what was built. |
| **PMI Mindset** | Corrective action and impact assessment. Always fix the process first to prevent further defects. |
| **The Trap** | Simply updating the risk register is passive; the PM must take immediate action to stop the non-conforming work. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | TDD is a core agile quality practice that ensures requirements are understood before coding and that code is inherently testable. |
| **PMI Mindset** | Shifting quality to the left. TDD prevents defects by clarifying acceptance criteria through tests. |
| **The Trap** | Adding a "quality phase" or more testers at the end is a reactive, predictive approach that contradicts agile principles of continuous quality. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The cost of non-conformance ($100,000 external failure) is higher than the individual conformance costs. Shifting investment to prevention/appraisal reduces total CoQ. |
| **PMI Mindset** | Economic view of quality. Prevention is cheaper than failure. The PM uses data to justify quality investments. |
| **The Trap** | Reducing testing because of bugs is the opposite of what should be done; it would likely lead to even higher external failure costs. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Quality requirements must be measurable and actionable. Vague goals like "last 100 years" must be decomposed into technical metrics like corrosion resistance and load-bearing specs. |
| **PMI Mindset** | Requirement clarity and measurability. A PM's job is to ensure that "quality" is defined in a way that can be built and verified. |
| **The Trap** | Just adding it to the charter without technical decomposition makes it impossible to verify during the project's quality control phase. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Continuous improvement (Kaizen) involves experimenting with processes to find more efficient ways to maintain quality. Pair programming is a valid agile quality practice. |
| **PMI Mindset** | Empowering the team to improve their own processes while maintaining quality standards. Experiments allow for data-driven process changes. |
| **The Trap** | Cutting quality steps (skipping reviews) is a short-term gain that leads to higher technical debt and defects later. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Managing Quality (QA) in a multi-vendor environment requires process alignment. Audits help ensure that all parties are using effective and compatible quality processes. |
| **PMI Mindset** | Collaboration and process alignment. The PM must ensure the "whole system" quality, not just the individual parts. |
| **The Trap** | Penalizing vendors is a reactive approach that doesn't fix the underlying lack of process alignment. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Quality management involves meeting all defined standards and regulations. When standards conflict, the most stringent one typically prevails to ensure compliance and safety. |
| **PMI Mindset** | Integrity and compliance. A PM must ensure the project meets all agreed-upon quality and safety standards, not just the minimum legal requirements. |
| **The Trap** | Taking the "path of least resistance" by only meeting local codes ignores the internal governance and quality requirements of the organization. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Quality and security are non-negotiable. If time is fixed, scope must be flexible (the Triple Constraint). Cutting quality/security leads to potentially catastrophic external failure costs. |
| **PMI Mindset** | Protection of quality and security standards. The PM must communicate risks clearly and offer viable alternatives like scope reduction. |
| **The Trap** | "Market window" is a common justification for cutting corners, but the PMP answer always protects the quality/safety threshold. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Quality planning requires translating subjective stakeholder needs into objective, measurable metrics. This ensures that quality can be verified and controlled. |
| **PMI Mindset** | Measurability and balance. A PM must ensure all critical quality dimensions (performance and fitness for use) are quantified. |
| **The Trap** | Dismissing subjective requirements because they are "hard to measure" is a failure of the quality planning process. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A scatter diagram is specifically used to show the relationship (correlation) between two variables. |
| **PMI Mindset** | Knowing the right tool for the job. Identifying correlations helps in root cause analysis and process optimization. |
| **The Trap** | A control chart shows a single variable over time; a fishbone diagram shows potential causes but not the statistical relationship between two variables. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In Agile/Kanban, the focus is on flow. Swarming is a collaborative technique where the whole team focuses on a bottleneck to ensure quality and throughput. |
| **PMI Mindset** | Team collaboration and flow optimization. Quality is a whole-team responsibility, not just the testers' job. |
| **The Trap** | Increasing the WIP limit actually makes the problem worse by increasing multitasking and slowing down individual items. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When a better process is found (Continuous Improvement), the project's documentation should be updated through formal change control to standardize the improvement. |
| **PMI Mindset** | Continuous improvement within a governed framework. Don't just ignore the plan, but don't blindly follow an inferior plan either. |
| **The Trap** | Returning to a less efficient/safe method is counterproductive to the goal of quality (which includes efficiency and safety). |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Automation is an appraisal cost that significantly reduces internal and external failure costs over time, especially in iterative environments. |
| **PMI Mindset** | Investing in conformance to reduce non-conformance. Automation is essential for sustainable agile quality. |
| **The Trap** | "Be more careful" is not a process improvement. "Bug Fix" sprints are a sign of poor quality processes and don't fix the root cause. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Marginal analysis helps find the point where the cost of an additional unit of quality equals the benefit it provides. It's used for optimization decisions. |
| **PMI Mindset** | Economic optimization of quality. A PM must find the "sweet spot" where quality requirements are met without over-investing. |
| **The Trap** | A Pareto chart is for prioritizing existing defects, not for making forward-looking investment decisions. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | DMAIC stands for Define, Measure, Analyze, Improve, Control. After measuring and analyzing the data, the goal of the Analyze phase is to find root causes. |
| **PMI Mindset** | Following a structured improvement methodology. You must find the cause before you can implement an improvement. |
| **The Trap** | Implementing a solution (Improve) comes after finding the cause (Analyze). Defining goals (Define) happens at the start. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Regulatory compliance is a hard constraint in quality management. You cannot "waive" or "circumvent" legal requirements in a professional project. |
| **PMI Mindset** | Ethical and legal responsibility. Safety and compliance are never sacrificed for speed or feedback. |
| **The Trap** | Waivers are often legally insufficient and don't meet the project's quality/compliance obligations. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In attribute sampling (Pass/Fail), if the number of defects in the sample exceeds the acceptance level (1% of 500 = 5), the entire population/lot is rejected. |
| **PMI Mindset** | Understanding statistical sampling principles. Sampling is used to make decisions about the whole population based on a subset. |
| **The Trap** | Rerejecting only the sample defects defeats the purpose of sampling, which is to validate the quality of the whole lot. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Benchmarking and alignment are key when dealing with different quality standards. The PM must ensure the project's specific needs are met while respecting established systems. |
| **PMI Mindset** | Integration and pragmatic quality management. Don't assume, but don't be unnecessarily rigid either. |
| **The Trap** | "Assuming" quality based on a certificate is a failure of the quality planning process. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | "Fitness for use" is about the customer's satisfaction. "Conformance to requirements" includes internal technical standards like coding guidelines. |
| **PMI Mindset** | Understanding the dual nature of quality. A product must satisfy both the end-user and the technical/operational requirements. |
| **The Trap** | Confusing grade (features) with quality (meeting requirements). In this case, the product meets functional needs but fails on technical standards. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When a quality metric is not met, the PM must analyze the impact and provide a professional recommendation/plan to the governing body (Phase Gate). |
| **PMI Mindset** | Professional integrity and impact assessment. Don't hide the variance, but provide a forward path based on risk analysis. |
| **The Trap** | Automatically delaying might be an overreaction if the 5% has low risk, but ignoring it is a breach of quality governance. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The "Act" phase of PDCA involves learning from the results. If the results didn't meet expectations, you analyze the gap and start a new cycle with better information. |
| **PMI Mindset** | Continuous, iterative improvement. Failure to meet a target is a learning opportunity, not a reason to stop or blindly standardize a poor result. |
| **The Trap** | "Standardizing" a failure or an underperformance is not the goal of PDCA; the goal is to reach the desired state through iterative cycles. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Pareto chart is specifically designed to prioritize issues based on the 80/20 rule (the principle of the "vital few"). |
| **PMI Mindset** | Resource prioritization. A PM must focus the team's limited resources on the issues that have the greatest impact on quality. |
| **The Trap** | While a histogram shows frequency distribution, it doesn't sort by frequency and include a cumulative percentage line like a Pareto chart does. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | BDD helps align the team and the stakeholders on the expected behavior of a feature through concrete examples, reducing misinterpretation and rework. |
| **PMI Mindset** | Clarifying requirements through collaborative techniques. BDD is a proactive quality practice that reduces failure costs. |
| **The Trap** | "More documentation" (predictive approach) is usually not the answer in an agile environment where collaborative clarity is preferred. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Quality management includes proactive compliance. If a process is trending toward a violation, the PM must take preventive action to stay within limits. |
| **PMI Mindset** | Proactive compliance and ethical responsibility. A PM must prevent violations, not just record them or hide them. |
| **The Trap** | "Recording for the final audit" is a reactive approach that accepts a failure; "under-reporting" is an ethical violation. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When requirements cannot be met with current processes/tools, the PM must evaluate options (Make vs. Buy/Upgrade) to bridge the capability gap. |
| **PMI Mindset** | Realistic quality planning. You cannot plan for a quality level that your processes are incapable of delivering without making changes. |
| **The Trap** | "Lowering requirements" without stakeholder approval is a quality failure. "Trying your best" with 100% inspection leads to high internal failure costs (scrap). |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | If a quality gate (DoR) is failing to catch a specific type of issue, the gate must be updated and strengthened through continuous improvement. |
| **PMI Mindset** | Process improvement through the team. The DoR is a quality standard that should evolve based on the team's experience. |
| **The Trap** | Creating a separate sprint or a new role adds overhead and doesn't fix the underlying quality process of story readiness. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Process quality is just as important as product quality. Automation (CI/CD) reduces human error and improves the reliability/quality of the delivery process. |
| **PMI Mindset** | Focusing on process improvement (Manage Quality) to prevent defects in the final delivery step. |
| **The Trap** | "Doing it more carefully" doesn't fix a fundamentally flawed/inefficient manual process. CI/CD is the standard for high-quality delivery. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Measure phase of DMAIC is about establishing a baseline of current performance before any changes are made. |
| **PMI Mindset** | Data-driven baselining. You can't improve what you haven't measured. |
| **The Trap** | Finding causes happens in the "Analyze" phase. Pilot projects happen in the "Improve" phase. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Proper knowledge transfer and quality handoff are essential during project closure. The impact of unresolved defects must be managed and communicated. |
| **PMI Mindset** | Professional responsibility and transparency. You don't just "dump" quality issues on the next team without a plan. |
| **The Trap** | Deleting or hiding defects is unethical; fixing everything might be a poor business decision if the cost exceeds the value. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Flowcharts are used to visualize a process to identify bottlenecks, redundancies, and inefficiencies. Seven signatures for an expense report is a clear bottleneck. |
| **PMI Mindset** | Process analysis for improvement. Visualizing the "how" helps identify where the process is failing to be efficient/high-quality. |
| **The Trap** | A flowchart doesn't show correlation (Scatter) or statistical control (Control Chart); it shows the sequence of steps. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Before taking action on a change (like a new standard), the PM must first assess the impact (gap analysis) to understand what needs to change. |
| **PMI Mindset** | Impact assessment before action. You need to know the size of the gap before you can plan a response or ask for resources. |
| **The Trap** | Ignoring new standards can lead to compliance failure at the end of the project. Updating without analysis is premature. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Quality requirements must be objective and measurable. Quantifying subjective terms like "fast" is a key part of quality planning. |
| **PMI Mindset** | Requirement quantification. A PM's role is to facilitate the definition of clear, testable acceptance criteria. |
| **The Trap** | "Feels fast" is not a quality metric. Optimization at the end is often more difficult and expensive (Shift-Left principle). |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When the process itself is failing (causing integration errors), the focus should be on Manage Quality (QA) to improve the process effectiveness. |
| **PMI Mindset** | Process improvement over more testing. If you fix the process, you prevent the defects from occurring in the first place. |
| **The Trap** | More testing (QC) might find the defects, but it doesn't stop them from happening, which is the goal of QA. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Appraisal costs are incurred while measuring and auditing products or services to ensure they conform to quality standards. |
| **PMI Mindset** | Understanding CoQ categories. Training is Prevention; Rework is Internal Failure; Warranty is External Failure. |
| **The Trap** | Confusing prevention (before defect) with appraisal (during/after production but before release). |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The DoD is a commitment by the team to maintain quality. If it's not being followed, the PM must address the underlying cause (e.g., pressure, lack of value) through a collaborative team discussion. |
| **PMI Mindset** | Servant leadership and protecting the team's quality standards. The DoD is non-negotiable for a "Done" increment. |
| **The Trap** | Removing quality steps to save time is "cutting corners" and leads to technical debt. The PM should not do the team's work (reviews). |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Kaizen is the philosophy of continuous, small, incremental improvements involving everyone in the organization. |
| **PMI Mindset** | Continuous improvement culture. It's about ongoing, bottom-up improvements rather than top-down "overhauls." |
| **The Trap** | Kaizen is not about penalties or one-time big changes; it's about a consistent mindset of finding better ways to work every day. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Metrics are used to identify trends and trigger improvements. A retrospective is the primary agile vehicle for responding to quality data. |
| **PMI Mindset** | Data-driven continuous improvement. Use the data to have a honest conversation about process health and take action. |
| **The Trap** | Increasing velocity when quality is failing is a recipe for disaster; it will only lead to more bugs and more technical debt. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Using industry standards (Benchmarking) like LEED provides a ready-made set of measurable quality metrics for complex requirements like sustainability. |
| **PMI Mindset** | Using standards to define quality. Standards provide a common language and verifiable targets for stakeholders and the team. |
| **The Trap** | "Green materials" is too vague to be a quality requirement that can be audited or controlled. |
| **Source Link** | guide/06-project-planning/quality-planning.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A trend is a consistent movement in one direction (6+ points). While this is only 5 points, it's a strong indicator that the process is drifting and needs attention before it hits the limit. |
| **PMI Mindset** | Proactive process monitoring. Identifying trends early allows for corrective action before defects (out-of-limit points) occur. |
| **The Trap** | Don't wait for a point to go outside the limits if you see a clear, consistent trend developing. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Security and compliance are critical quality requirements. Vulnerabilities must be addressed as soon as they are identified, regardless of their source. |
| **PMI Mindset** | Risk management and integrity. A PM must protect the product's quality and the organization's reputation by addressing compliance issues head-on. |
| **The Trap** | Delaying security fixes (Technical Debt) increases the risk of a catastrophic external failure. Hiding it is unethical. |
| **Source Link** | guide/07-risk-quality/quality-management.md |
...
| :--- | :--- | :--- |
| **1. Gather quality requirements** | 6, 14, 19, 24, 30, 35, 42, 48 | 8 |
| **2. Plan quality processes and tools** | 7, 12, 15, 20, 28, 32, 36, 40, 47 | 9 |
| **3. Execute quality management plan** | 3, 11, 16, 22, 37, 43, 45 | 7 |
| **4. Help ensure regulatory compliance** | 5, 17, 26, 34, 41, 50 | 6 |
| **5. Manage cost of quality (CoQ)** | 1, 8, 13, 18, 23, 29, 33, 39, 44 | 9 |
| **6. Conduct ongoing quality reviews** | 4, 10, 21, 27, 49 | 5 |
| **7. Implement continuous improvement** | 2, 9, 25, 31, 38, 46 | 6 |
