# Practice Exam: People Task 1 - Develop a Common Vision

## Introduction
This practice exam focuses on the Project Manager's ability to develop, promote, and maintain a shared vision among stakeholders and the project team. It covers strategic alignment, charter development (both project and team), and root-cause analysis of vision misunderstandings.
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The project charter is the strategic anchor that defines high-level goals and success criteria. When key stakeholders disagree on the "why," the PM must collaborate with the sponsor to refine these elements in the charter to ensure alignment before planning proceeds. |
| **PMI Mindset** | The PM is a facilitator of consensus and alignment. Rather than picking sides or avoiding the conflict, the PM uses the chartering process to drive clarity on strategic value. |
| **The Trap** | Including both sets of requirements without reconciliation leads to scope creep and conflicting goals. Escalation should only happen after facilitation attempts fail. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In agile, the vision statement is the "Elevator Pitch" that provides the team with a sense of purpose and helps the Product Owner prioritize based on value. It defines the target customer, the need, and the unique benefit. |
| **PMI Mindset** | Agile leadership focuses on providing the "why" and then empowering the team to figure out the "how." A clear vision statement is the tool for this. |
| **The Trap** | Telling the team to just focus on tasks ignores the root cause of demotivation (lack of purpose). A Gantt chart is a predictive tool and doesn't necessarily convey "vision." |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Strategic alignment requires continuous validation. PESTLE (Political, Economic, Social, Technological, Legal, Environmental) is used to scan the external environment for shifts that might make the project's vision obsolete. |
| **PMI Mindset** | PMs must have the courage to "Pivot or Persevere." If the environment shifts, the PM must assess the impact on value, not just on the schedule or budget. |
| **The Trap** | SPI measures efficiency, not relevance. Speeding up a project that is no longer strategically aligned is a waste of resources. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A shared vision depends on clear, measurable success criteria. Without these, stakeholders will have subjective and often conflicting interpretations of what "success" looks like. |
| **PMI Mindset** | High-level goals must be translated into measurable outcomes early in the project (during initiation) to prevent later misalignment. |
| **The Trap** | While communication frequency is important, the root cause here is the lack of a clear, agreed-upon definition of success in the foundational document. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A Team Charter (or Social Contract) is the "North Star" for team behavior. It helps build a shared understanding of how the team will work together to achieve the project vision. |
| **PMI Mindset** | High-performing teams define their own guardrails. The PM facilitates the creation of these rules but does not impose them. |
| **The Trap** | Roles and responsibilities (RACI) are different from behavioral norms and values. Technical training doesn't solve a culture/vision conflict. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | To promote a shared vision, the PM must connect the project's outputs to the organization's strategic goals. The charter serves as the bridge between the business case and project execution. |
| **PMI Mindset** | PMs should use influence and strategic alignment rather than just relying on formal authority or escalation. |
| **The Trap** | While the charter provides formal authority, using it as a "threat" (Distractor 1) or immediately escalating (Distractor 3) damages long-term stakeholder engagement. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In agile, the vision is adaptive. When hypotheses are invalidated by feedback, the PM and Product Owner must "Pivot" the vision to ensure the project continues to deliver maximum value. |
| **PMI Mindset** | Agile is about continuous validation. Keeping the vision current means embracing change when it leads to better alignment with user needs and strategic value. |
| **The Trap** | Sticking to a failing plan (Distractor 1) is a classic failure mode. Agile visions don't require the heavy formal re-chartering process of predictive projects for every pivot (Distractor 3). |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Misunderstandings often stem from a lack of "working agreements" that bridge different ways of working. The Team Charter should define how these two groups interact, make decisions, and manage dependencies. |
| **PMI Mindset** | The PM looks for systemic or process-based root causes (like a missing or inadequate team agreement) rather than just treating symptoms or picking sides in a technical debate. |
| **The Trap** | Forcing a single methodology (Distractor 1) often ignores the practical reasons why different teams use different approaches (e.g., physical hardware vs. digital software). |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The charter is a high-level document. Over-detailing it too early can lead to "false precision" and a loss of focus on the strategic "why." Detailed planning happens *after* the charter is approved. |
| **PMI Mindset** | The PM must guide stakeholders on the proper use of project artifacts. A charter provides authorization and vision; the PMP provides the execution details. |
| **The Trap** | Putting a WBS or detailed schedule in the charter makes the charter too brittle and difficult to manage, as it would require sponsor approval for even minor task changes. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | "Promoting the vision" involves making it visible and easy to understand. Information radiators (like a visual roadmap) are key agile tools for transparency and alignment. |
| **PMI Mindset** | Transparency and clear communication are the best ways to manage stakeholder expectations and maintain a shared vision. |
| **The Trap** | Sending a 50-page document (Distractor 1) is ineffective as most people won't read it. Inviting everyone to a Standup (Distractor 2) makes the meeting unproductive. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Strategic alignment is a "decision filter." When the organization's strategy changes, the PM must assess the impact on the project's value proposition and bring options to governance. |
| **PMI Mindset** | The PM doesn't make the final "stop/pivot" decision but provides the analysis and recommendations to those who do (Sponsor/Steering Committee). |
| **The Trap** | "Self-canceling" (Distractor 1) or "Scope Creep" (Distractor 3) are incorrect. The PM must follow formal governance processes. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Definition of Done (DoD) is a shared understanding of quality. If there is a misunderstanding, the team must collaborate to clarify it in their working agreements. |
| **PMI Mindset** | Problems with "done" are usually process or agreement problems, not individual performance problems. Collaboration is the preferred fix. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In agile, visioning is a collaborative process. Tools like "Product Box" or "Elevator Pitch" workshops help the team internalize the "why" so they can make better day-to-day decisions. |
| **PMI Mindset** | Shared understanding is built through collaboration, not just documentation. The PM facilitates this bridge between business and technology. |
| **The Trap** | Coding without a vision (Distractor 2) leads to wasted effort on features that don't meet the strategic need. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A "Definition of Ready" is a shared agreement that prevents misunderstandings about vision and scope at the task level. It ensures the team has what they need to succeed before they commit to the work. |
| **PMI Mindset** | When there is friction between roles, the PM looks for a missing "working agreement" or "standard" that can align expectations. |
| **The Trap** | Forcing the team to accept vague stories (Distractor 2) will only lead to more rework and lower velocity later in the Sprint. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Promoting the vision means finding the "thread of value." Even internal projects usually have a connection to the ultimate customer; the PM's job is to make that connection visible to the team. |
| **PMI Mindset** | Servant leaders connect people's work to a higher purpose. Strategic alignment isn't just for external-facing teams; it's the foundation of all project work. |
| **The Trap** | Using financial incentives (Distractor 2) to fix a "purpose" problem is a temporary measure that doesn't address the root cause of demotivation. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In hybrid projects, "Alignment" means managing different stakeholder expectations. A Roadmap provides the vision and "what comes when" without the false precision of a long-term task-based schedule for agile work. |
| **PMI Mindset** | The PM must act as a bridge between agile teams and traditional governance, using the right "artifact for the audience" to maintain trust and vision. |
| **The Trap** | Creating a detailed Gantt for agile (Distractor 1) is "Water-Agile-Fall" and usually leads to missed deadlines and a broken vision. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Keeping the vision current involves scanning the horizon for "External Business Environment Changes" (PESTLE). Regulatory changes are a critical trigger for re-evaluating project vision and alignment. |
| **PMI Mindset** | The PM is proactive about compliance. Ignoring a legal change (Distractor 3) or delaying it (Distractor 1) puts the entire organization at risk. |
| **The Trap** | While stakeholders should share info, the PM is ultimately responsible for ensuring the project delivers a compliant and valuable outcome. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Organizational Process Assets (OPAs), like PMO templates, are meant to help, not hinder. A professional PM uses these tools to ensure governance and alignment are maintained efficiently. |
| **PMI Mindset** | The PM works within the organizational structure. If a process is truly an impediment, the PM suggests improvements rather than bypassing or ignoring it. |
| **The Trap** | Shadow systems (Distractor 1) create confusion and risk. The PMO is a stakeholder that needs to be engaged, not avoided. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Product Vision is the "Filter" for the backlog. If new ideas don't fit, the PM must facilitate a strategic conversation: either the ideas go, or the vision must change. |
| **PMI Mindset** | Change is welcome in agile, but it must be purposeful and aligned. The PM ensures that "Pivot vs. Persevere" decisions are made transparently and collaboratively. |
| **The Trap** | Accepting everything (Distractor 1) leads to a "Franken-product" with no clear purpose or vision. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Hybrid success depends on aligning "Ways of Working" (governance) with the project's vision. If managers don't know how to measure progress in the new system, it's a governance alignment failure. |
| **PMI Mindset** | The PM is responsible for bridging the gap between the team's execution and the organization's governance needs. |
| **The Trap** | While the board usage (Distractor 1) might be a factor, the root cause is the lack of an agreed-upon reporting vision between the PMO and the project. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Promoting a vision is about making it *real*. Connecting the team directly to the "value" (the customer) is the most powerful way to re-energize a demotivated team. |
| **PMI Mindset** | Servant leadership focuses on empathy and purpose. When the team loses the "why," the PM's job is to bring the "why" back into focus. |
| **The Trap** | Velocity is a result, not a motivator. Pushing for higher numbers (Distractor 2) without addressing the "purpose gap" usually leads to burnout and lower quality. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In a dynamic business environment, the PM must constantly re-validate the project's "Right to Exist." Proactive alignment checks are key to project survival and relevance. |
| **PMI Mindset** | The PM is a business partner. When the organization's portfolio shifts, the PM helps the organization make the right decision for the project's future. |
| **The Trap** | Hiding information (Distractor 1) is unethical and eventually leads to a loss of trust and project termination. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The Team Charter is a "Living Document." It must be reviewed regularly, especially when team composition changes or the project moves into a new phase. |
| **PMI Mindset** | Agile teams are self-organizing. The PM facilitates the *opportunity* for the team to update their own agreements but doesn't do it for them. |
| **The Trap** | Success can lead to complacency. A stale charter (Distractor 1) can fail to protect the team when new conflicts inevitably arise in a more complex phase. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | "Enterprise Environmental Factors" (EEF) like organizational and national culture significantly impact how teams build a shared vision. These must be addressed in the Team Charter's ground rules. |
| **PMI Mindset** | The PM is culturally aware. They look for ways to create a safe space for all voices to be heard, regardless of cultural background. |
| **The Trap** | Assuming a lack of competence (Distractor 1) is a common bias. Directing/forcing (Distractor 2) doesn't build a *shared* vision; it just builds compliance. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Hybrid success requires a balance of "Control" and "Flexibility." Guardrails provide the strategic vision and boundaries that reassure stakeholders while still enabling the benefits of agile execution. |
| **PMI Mindset** | The PM addresses stakeholder fears through transparency and governance, not just by demanding trust or forcing a methodology that doesn't fit the situation. |
| **The Trap** | Freezing requirements (Distractor 1) defeats the purpose of using agile for development. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The charter must be linked to the business case. If they are misaligned, the project's "Why" is unclear, which will lead to prioritization conflicts during execution. |
| **PMI Mindset** | The PM is responsible for the integrity of the project's foundation. Discrepancies between key initiation documents must be resolved early through collaboration with the sponsor. |
| **The Trap** | Adding "feel-good" goals (Distractor 3) that aren't in the business case can lead to scope creep and a lack of focus on the project's actual investment justification. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Vision alignment includes "How we define progress." If the team and the committee have different definitions of "Success" (working software vs. documentation), friction is inevitable. |
| **PMI Mindset** | The PM identifies the gap between "delivery" and "governance." The fix is to align these definitions in the project's charter and ground rules. |
| **The Trap** | Blaming the team (Distractor 1) or the committee (Distractor 2) ignores the systemic failure to define shared success criteria for the hybrid approach. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Promoting a vision requires active engagement of detractors. One-on-one sessions allow the PM to address specific concerns and "sell" the vision without the pressure of a public forum. |
| **PMI Mindset** | PMs use influence and relationship-building to align difficult stakeholders. Public confrontation or exclusion are last resorts that usually backfire. |
| **The Trap** | Ignoring a powerful detractor (Distractor 3) allows their negative influence to grow, which can eventually derail the project's support. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | "Keeping the vision current" means re-validating the project's value proposition when the business environment shifts. Financial metrics (ROI, NPV) are often used to bridge the gap between sustainability and profitability. |
| **PMI Mindset** | The PM is a business steward. When strategy shifts, they provide the data needed to decide whether to pivot the project's vision or persevere. |
| **The Trap** | Emotional attachment to a vision (Distractor 1) can lead to a project that is no longer strategically aligned with its funding organization. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A change in key leadership (Sponsor) requires a "re-alignment" of the project vision. The charter is the primary tool for this conversation. |
| **PMI Mindset** | The PM proactively manages the transition of power. Ensuring the *current* sponsor supports the *current* vision is critical for project success. |
| **The Trap** | Assuming the charter is "static" (Distractor 1) is a mistake; if the sponsor doesn't support the vision, the project has no authority. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Shared vision isn't just about "what" we build, but "how" we build it (Quality). When team members bypass standards for short-term gain, they have lost sight of the broader vision for the product's lifecycle. |
| **PMI Mindset** | Problems with DoD compliance are usually culture or alignment problems. The PM must facilitate a session to re-align the team on *why* the documentation matters for the project's vision. |
| **The Trap** | "Agile" does not mean "no documentation." It means "just enough documentation to add value." In hybrid, the value often includes meeting predictive governance needs. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The "Strategic Hierarchy" (Portfolio -> Program -> Project) requires that all levels be aligned. Conflicts at the project level must be resolved at the program level to ensure overall benefit realization. |
| **PMI Mindset** | The PM is aware of the broader context. "Doing the project right" is useless if it's "the wrong project" for the program's overall vision. |
| **The Trap** | Internal competition (Distractor 1) is destructive and wastes organizational resources. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Promoting a shared vision in hybrid means finding a "Common Language of Value." A high-level Roadmap allows different methodologies to coexist while showing how they contribute to a single timeline. |
| **PMI Mindset** | The PM is an "Integration Agent." They don't force one methodology on everyone; they find the points of connection between different ways of working. |
| **The Trap** | Tool-mandates (Distractors 1 & 2) often lead to poor data and team frustration. The goal is *vision* alignment, not *tool* alignment. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Culture (an EEF) is often the "hidden" root cause of vision failure. If the organization's culture doesn't support the project's goals (e.g., innovation vs. risk-aversion), the vision will struggle to take root. |
| **PMI Mindset** | The PM recognizes that culture is a constraint. The fix involves working with the sponsor to create a "Safe Harbor" for the project team within the larger organization. |
| **The Trap** | While a risk plan (Distractor 1) helps, it doesn't solve the fundamental cultural mismatch between the team's fear and the project's goals. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Shared vision in virtual teams requires explicit "Social Contracts." Without clear norms for how to interact remotely, the team will fail to develop the trust needed for a shared vision. |
| **PMI Mindset** | The PM uses "Working Agreements" to solve behavioral problems. They treat the team with respect (no monitoring software) while holding them accountable to agreed-upon norms. |
| **The Trap** | While face-to-face (Distractor 1) is ideal, it's often not feasible. The PM must find digital ways to build the same alignment and vision. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The charter is the "Vision Filter." Every change request should be evaluated against the high-level goals and success criteria defined during initiation to prevent scope creep. |
| **PMI Mindset** | The PM uses the charter as a tool for saying "No" (or "Not now") in a way that is objective and strategically grounded. |
| **The Trap** | "Gold plating" or "Scope creep" (Distractor 1) is a major project failure mode, even if it's done to please a stakeholder. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Keeping the vision current means ensuring that everyone understands progress in a way that is meaningful to them. In hybrid, this often involves "Translating" agile data into predictive reporting formats. |
| **PMI Mindset** | The PM is a "Communicator-in-Chief." They find ways to satisfy different stakeholder needs without creating unnecessary rework or losing the team's data-driven insights. |
| **The Trap** | Disconnecting reporting (Distractor 3) leads to "two versions of the truth," which destroys the shared vision of where the project actually stands. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | "Vision Fatigue" is a real risk in long projects. Re-promoting the vision involves reminding the team of the "Why," celebrating progress, and ensuring the vision is still relevant to the current business context. |
| **PMI Mindset** | Servant leaders recognize when morale is low and take proactive steps to re-engage the team's hearts and minds, not just their hands. |
| **The Trap** | Using fear (Distractor 1) or just money (Distractor 2) doesn't solve the underlying problem of a loss of purpose and alignment. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | "Vision Fragmentation" often occurs when foundational documents (Charter) are not sufficiently socialized or detailed for a distributed team. The first step is to verify if the core vision was ever actually shared. |
| **PMI Mindset** | The PM looks for the "artifact-based" root cause first. If the charter is vague or hasn't been discussed with everyone, that's where the alignment failure started. |
| **The Trap** | While cultural training (Distractor 1) is good, it doesn't fix a lack of clarity in the project's fundamental goals and success metrics. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A project can only have ONE "Source of Truth" (the Charter). Multiple charters create a fragmented vision that is impossible to manage. The PM must facilitate the creation of a single, authorized vision. |
| **PMI Mindset** | The PM is an "Alignment Agent." They take the lead in resolving stakeholder conflicts during initiation to ensure the project has a solid foundation. |
| **The Trap** | "Waiting" (Distractor 3) is too passive. The PM should take an active role in facilitating the resolution. Picking a "winner" (Distractor 1) creates a powerful enemy and a failed project vision. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Promoting a shared vision involves finding the "Common Ground" between competing priorities. Sustainability (Scrum Master) and Value (Product Owner) are two sides of the same coin. |
| **PMI Mindset** | The PM doesn't pick a "winner" role; they facilitate a balanced approach where both technical health and business value are recognized as essential parts of the project's vision. |
| **The Trap** | Prioritizing one role over the other (Distractors 1 & 2) creates a toxic team dynamic and eventually leads to a failure of both the product and the team. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Visions must evolve as projects move through different phases or face new external constraints (PESTLE). Compliance is often a non-negotiable part of a project's "Right to Exist." |
| **PMI Mindset** | The PM is proactive. When the environment changes (new regulations), the vision must be updated to ensure the project remains viable and compliant. |
| **The Trap** | Ignoring regulations (Distractors 1 & 2) is a critical failure that can lead to legal action and project termination. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | OPAs (Historical Data) are meant to help the PM avoid past mistakes. Incorporating learned "Success Criteria" (like User Adoption) into the charter ensures the new vision is more robust. |
| **PMI Mindset** | The PM is a continuous learner. They use the organization's knowledge base to improve the strategic alignment and success of their own projects. |
| **The Trap** | Blaming others (Distractor 2) is unprofessional and doesn't improve the project vision. Total avoidance of technical terms (Distractor 3) is unrealistic and hinders communication. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The root cause of "Pivot vs. Persevere" disagreements is usually a lack of data on the project's "Unique Value Proposition." Facilitating data-driven analysis is the best way to resolve the misunderstanding. |
| **PMI Mindset** | The PM facilitates the gathering of information to enable a strategic decision. They don't just "vote" on a whim or let one person dictate the direction without evidence. |
| **The Trap** | Voting (Distractor 2) doesn't solve the underlying problem: the team doesn't know *why* one path is better than the other. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Vendor alignment is a major hybrid challenge. The PM must bridge the gap between "Legal/Contractual" needs and "Visionary/Strategic" needs through collaborative alignment sessions. |
| **PMI Mindset** | The PM manages the vendor relationship as a partnership. Both parties must understand how the "what" (deliverables) contributes to the "why" (vision). |
| **The Trap** | Ignoring the contract (Distractor 1) is a legal risk. Lowering expectations (Distractor 2) is a failure of the PM's role as a steward of organizational value. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Promoting a vision means adapting it to reality. Safety and Compliance are core "Enterprise Environmental Factors" (EEF) that must be integrated into the project's identity and vision. |
| **PMI Mindset** | Ethics and Compliance come first. A PM never encourages "bypassing" laws (Distractor 2) and instead finds a way to deliver value within the legal framework. |
| **The Trap** | A 5% drop in efficiency doesn't make a project a failure (Distractor 3); the PM must manage the stakeholder expectations regarding the new, safer vision. |
| **Source Link** | `guide/02-strategic/strategy-alignment.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Agile teams sometimes drift from the vision. The PM's role is to act as a "Guardrail," gently bringing the team back to the agreed-upon vision and scope without being overly directive. |
| **PMI Mindset** | Servant leaders facilitate correction through reminders and alignment checks. They avoid "punishing" the team and instead focus on helping the team stay focused on the most valuable work. |
| **The Trap** | Ignoring scope drift (Distractor 1) leads to "Gold Plating" and a loss of focus on the project's actual goals. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Shared vision requires "Translating" technical work into business value. An Elevator Pitch is the perfect tool for communicating the "Why" to a non-technical audience. |
| **PMI Mindset** | The PM is a "Value Translator." They bridge the gap between technical execution and business strategy, ensuring everyone understands the project's contribution to the bottom line. |
| **The Trap** | Overloading stakeholders with technical detail (Distractor 1) only increases their confusion and disengagement. |
| **Source Link** | `guide/05-initiation/project-charter.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Shared vision is strongest when it is "Personalized." A Team Charter that connects the team's own values and rules to the project's success is the most powerful tool for building engagement. |
| **Source Link** | `guide/03-team-leadership/team-charter.md` |
...
| Question # | Enabler | Methodology | Core Topic |
| :--- | :--- | :--- | :--- |
| 1-5 | 1, 2, 3, 4, 1 | P, A, H, P, A | Chartering, Vision Pitch, PESTLE, Metrics, Team Values |
| 6-10 | 2, 3, 4, 1, 2 | P, A, H, P, A | Strategic Justification, Pivot, Working Agreements, Charter Detail, Radiators |
| 11-15 | 3, 4, 1, 4, 2 | P, H, A, A, A | Portfolio Shift, DoD Alignment, Visioning, DoR, Purpose Thread |
| 16-20 | 1, 3, 2, 1, 4 | H, A, P, A, H | Roadmaps, Compliance, PMO Force-Multiplier, Vision Filter, Governance |
| 21-25 | 2, 1, 3, 4, 1 | A, P, A, H, A | User Connection, Strategic Survival, Charter Refresh, Culture, Scaling |
| 26-30 | 2, 1, 4, 2, 3 | H, P, H, P, H | Hybrid Guardrails, Business Case, Progress Definition, Detractors, NPV Pivot |
| 31-35 | 1, 4, 1, 2, 4 | P, H, P, H, P | New Sponsor, Quality Vision, Program Alignment, Unified Roadmap, Culture EEF |
| 36-40 | 1, 2, 3, 2, 4 | H, P, H, A, H | Virtual Norms, Scope Filtering, Reporting Translation, Vision Fatigue, Fragmentation |
| 41-45 | 1, 2, 3, 1, 4 | P, A, H, P, A | Joint Charters, Balanced Priorities, Scaling Pilot, OPA Refinement, UVP Analysis |
| 46-50 | 1, 2, 4, 1, 2 | H, P, A, H, P | Vendor Alignment, Safety Integration, Scope Drift, Elevator Pitch, Charter Personalization |
