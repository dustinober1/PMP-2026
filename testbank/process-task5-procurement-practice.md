# Practice Exam: Process Task 5 — Plan and Manage Procurement
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | For a well-defined scope where the goal is to minimize buyer risk, a Firm Fixed Price (FFP) contract is the standard choice. The seller assumes the cost risk, which incentivizes efficiency. |
| **PMI Mindset** | Use Fixed Price when scope is stable and clear. This shifts the financial risk of overruns to the seller. |
| **The Trap** | FPIF is tempting because it mentions "incentive," but FPIF is generally used when there's some uncertainty or a need for specific performance bonuses beyond just completion. FFP is the simplest and most effective for a "very well-defined" scope. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In an Agile environment, the focus is on collaboration and removing impediments. The Scrum Master should act as a servant leader to help the team find a way to stay productive. |
| **PMI Mindset** | Agile favors "Customer collaboration over contract negotiation." Instead of immediate escalation, work with the partner to find a technical workaround. |
| **The Trap** | Escalating to procurement is a predictive, reactive move that damages the partnership and doesn't solve the immediate technical block. |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Fairness and transparency are fundamental to procurement. All bidders must have equal access to the same information to ensure a level playing field. |
| **PMI Mindset** | Procurement ethics require that no single vendor receives an unfair advantage through private information. Any clarification provided to one must be provided to all. |
| **The Trap** | Providing the information immediately seems helpful but violates the "Fairness" rule and could lead to protests or legal issues from other bidders. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Cost-reimbursable contracts are best when the scope is uncertain or high-risk (like R&D). CPFF ensures the seller is reimbursed for costs plus a fixed profit, which is fair when costs are unpredictable. |
| **PMI Mindset** | When the buyer carries the cost risk due to scope uncertainty, use Cost Plus. This prevents the vendor from padding their bid excessively for risk they can't define. |
| **The Trap** | T&M is used for staff augmentation or quick needs, but for a structured engagement like lab testing, CPFF provides better cost control for the buyer than an open-ended T&M. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Agile emphasizes continuous improvement and collaboration. Bringing the vendor into the retrospective allows for a transparent discussion of the problem and joint problem-solving. |
| **PMI Mindset** | Solve problems through communication and process improvement first. The "Agile Way" is to integrate partners into the team's feedback loops. |
| **The Trap** | Penalizing the vendor or doing the work for them doesn't fix the underlying process disconnect and damages the relationship. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Make-or-buy analysis is specifically designed to evaluate the costs, benefits, and risks of internal development versus external procurement. |
| **PMI Mindset** | Before procuring, you must decide IF you should procure. This involves looking at internal capacity, core competencies, and long-term costs. |
| **The Trap** | Resource leveling is about scheduling, not about the strategic decision to outsource or build. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Negotiation should aim for a "win-win" where both parties' needs are met. Trading value (like future work) for immediate cost savings is a classic collaborative technique. |
| **PMI Mindset** | Negotiations are not a battle; they are a collaborative problem-solving exercise to reach a fair agreement that ensures vendor commitment. |
| **The Trap** | Threatening the vendor or demanding they lose money leads to "lose-win" or "lose-lose" situations where the vendor may later cut corners or abandon the project. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In Agile and Hybrid projects, verification should be continuous. The sprint review is the primary mechanism for the customer (PM) to verify that the increment meets the requirements and provides value. |
| **PMI Mindset** | Verify often and early. Don't wait for the end of a procurement to find out the objectives weren't met. |
| **The Trap** | Waiting until the end of the contract is a traditional mistake that increases the risk of delivering the "wrong thing" very efficiently. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In a hybrid delivery model (internal + external), the most common failure point is the "interface" or the "hand-off." The SOW must explicitly define who is responsible for integration and how the teams will interact. |
| **PMI Mindset** | Procurement success starts with a high-quality SOW. If you don't define the boundaries of the work, you'll have gaps and conflicts. |
| **The Trap** | An FFP contract is a price mechanism, but it doesn't solve the delivery coordination problem, which is the primary challenge in this scenario. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A weighted scoring system allows the buyer to assign specific weights to different criteria (e.g., 60% Technical, 40% Price), ensuring that technical capability can outweigh cost in the final decision. |
| **PMI Mindset** | Use source selection criteria to align vendor selection with project priorities. Weighting systems provide transparency and objectivity. |
| **The Trap** | Least-cost selection would prioritize price, which is the opposite of the project manager's goal in this scenario. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | An unusually low bid is a major risk. It may indicate a misunderstanding of the scope or a strategy to "buy in" and then issue numerous change requests later. Clarification is essential for risk management. |
| **PMI Mindset** | Be proactive in identifying risks. A bid that is too good to be true usually is. Ensure the vendor understands the Statement of Work before moving forward. |
| **The Trap** | Awarding the contract without clarification often leads to cost overruns or vendor failure later in the project. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | FP-EPA contracts are specifically designed for long-term projects where external economic factors (inflation, commodity prices) are beyond the control of both parties. |
| **PMI Mindset** | Protect both the buyer and seller from external economic volatility in long-term agreements. This ensures the contract remains viable for the duration. |
| **The Trap** | A standard FFP would force the seller to include a massive "risk premium" in their price, making it unnecessarily expensive for the buyer. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When reported performance doesn't match reality, a formal audit or inspection against the contractual SLAs is required to document the breach and trigger corrective actions. |
| **PMI Mindset** | Trust but verify. Use the contractually agreed-upon metrics and audit rights to manage vendor performance. |
| **The Trap** | Relying on the vendor's own reporting when it contradicts the team's experience is a failure of the "Control Procurements" process. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | The contract defines when risk transfers from the seller to the buyer (e.g., FOB Shipping Point vs. FOB Destination). The PM must know who is legally responsible for the damage before taking action. |
| **PMI Mindset** | Let the contract guide the resolution of disputes and responsibilities. Do not make assumptions about liability. |
| **The Trap** | Filing an insurance claim or refusing to pay without checking the contract first is premature and may violate the agreement's terms. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In large organizations, the PM is a technical and operational advisor during negotiations, ensuring that what is being signed is actually deliverable and meets the project's needs. |
| **PMI Mindset** | The PM is the bridge between the legal contract and project execution. Their job is to ensure alignment between the two. |
| **The Trap** | PMs rarely have the authority to lead multi-million dollar legal negotiations or set prices; that is typically the role of procurement or executive management. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | A Fixed-Price Incremental (or "Graduated Fixed Price") approach provides the budget certainty the buyer wants (per sprint) while allowing the flexibility the seller needs for Agile scope changes. |
| **PMI Mindset** | Use creative contract structures to balance the needs of multiple stakeholders. Negotiation is about finding a viable middle ground. |
| **The Trap** | Demanding FFP for an uncertain Agile scope often leads to vendors over-estimating or later cutting quality to protect their margin. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When a vendor fails to perform despite warnings, the project manager must follow the legal process for default defined in the contract to protect the organization's interests. |
| **PMI Mindset** | Be decisive when a vendor is clearly failing. Follow the formal procedures for contract administration and escalation. |
| **The Trap** | Hiring a second vendor without terminating the first or issuing a default notice can create massive legal and financial liabilities. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | An RFI is used early in the procurement process to gather information about market capabilities and available solutions without committing to a purchase. |
| **PMI Mindset** | Use the right document for the right phase. Information gathering (RFI) precedes proposal solicitation (RFP). |
| **The Trap** | Issuing an RFP before the requirements are refined will lead to low-quality, incomparable proposals and wasted time for both the buyer and sellers. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Agile procurement success depends on partnership and shared vision. Including the vendor in team chartering builds trust and ensures everyone understands the "Why" behind the work. |
| **PMI Mindset** | Collaborative procurement is more effective than punitive or rigid structures, especially for Agile work where scope is expected to evolve. |
| **The Trap** | Detailed specs in an Agile project are a contradiction and often lead to rework and conflict when the market or customer needs change. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Physical resource availability is a major constraint. In a competitive market, early procurement or reservation is a key risk mitigation strategy. |
| **PMI Mindset** | Be proactive. When you identify a scarce resource, secure it early in the planning process. |
| **The Trap** | Waiting for execution to save money (Distractor 1) is a high-risk gamble that can lead to massive project delays if the resource is unavailable. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | To ensure fair and accurate bidding, you should provide necessary technical context while protecting sensitive business data. All bidders must receive the same information. |
| **PMI Mindset** | Transparency and fairness are paramount. If information is relevant to the bid, find a way to share it equitably. |
| **The Trap** | Refusing to share relevant technical data (Distractor 2) leads to "garbage in, garbage out" bids and increases project risk. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Price = Actual Cost + [Target Fee + (Target Cost - Actual Cost) * Seller Share]. Here: $110k + [$10k + ($100k - $110k) * 0.2] = $110k + [$10k - $2k] = $110k + $8k = $118k. This is below the $120k ceiling. |
| **PMI Mindset** | Understand the mechanics of incentive contracts. Both parties share in overruns or savings up to the ceiling price. |
| **The Trap** | Many students simply add the target fee to the actual cost ($120k) or hit the ceiling too early without doing the math. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In Agile, the team is a single unit. Problems should be solved within the team context first. A performance assessment identifies skills gaps that can be addressed through coaching or process changes. |
| **PMI Mindset** | "Individuals and interactions over processes and tools." Focus on team health and development before resorting to contractual penalties. |
| **The Trap** | Blaming individuals (Distractor 3) or immediately requesting replacements (Distractor 1) destroys team trust and ignores the possibility of process-related root causes. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Procurement requires formal documentation. If the scope changes, the contract/SOW must be updated through the change control process to protect both parties and ensure the objectives match the agreement. |
| **PMI Mindset** | Do not accept substandard or incomplete deliverables without following the formal change process. Informal agreements do not override the contract. |
| **The Trap** | Paying in full (Distractor 1) sets a dangerous precedent and leaves the buyer with no leverage to ensure the remaining scope is completed. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When a direct conflict occurs (Win-Lose), look for a collaborative solution (Win-Win). An incentive fee provides a "carrot" instead of a "stick," which can often achieve the same goal of schedule adherence. |
| **PMI Mindset** | Negotiations should be collaborative. If one party cannot accept a specific risk, find a different way to incentivize the desired behavior. |
| **The Trap** | Walking away (Distractor 1) might be necessary eventually, but a PM should first try to find a creative technical or contractual middle ground. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | BATNA is your power in a negotiation. Knowing that the vendor would struggle significantly if they lost the contract (since it's 40% of their revenue) gives the PM leverage, even if there are few other vendors. |
| **PMI Mindset** | Power in negotiation comes from understanding the other party's needs and alternatives. Use this data to reach a fair but favorable agreement. |
| **The Trap** | PTA (Distractor 1) is a specific cost-risk calculation for FPIF contracts, not a general negotiation strategy or source of leverage. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In a fixed-capacity Agile contract, the "what" (scope) is flexible while the "who/how much" is fixed. Backlog reprioritization is the standard way to handle changes without needing contract amendments. |
| **PMI Mindset** | Agile contracts should support the flexible nature of the work. Reprioritization is the primary mechanism for managing value within a fixed budget/capacity. |
| **The Trap** | Requiring a contract amendment for every backlog change (Distractor 1) would create massive administrative overhead and defeat the purpose of Agile. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Make-or-buy decisions should consider expertise and risk. If the organization lacks the expertise for a highly specialized and risky asset, buying (outsourcing to experts) is usually safer and more cost-effective. |
| **PMI Mindset** | Don't try to "make" something if you don't have the skills and the risk of failure is high. Leverage vendor expertise for specialized, non-core capabilities. |
| **The Trap** | While Distractor 1 mentions "core competency," building something complex from scratch with zero experience is a recipe for project failure. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Splitting a project between teams (internal/external) creates "seams." Managing the technical integration and the communication across different time zones/cultures is the PM's biggest challenge. |
| **PMI Mindset** | Delivery solutions that involve multiple parties must focus on interfaces, communication, and integration. |
| **The Trap** | IP theft (Distractor 1) is a risk, but by specifically keeping the business logic internal, the PM has already mitigated this, leaving integration as the primary remaining concern. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Make-or-buy is not just about direct price. Opportunity cost (what you lose by not doing something else) and the risk of penalties on other projects are vital "hidden" costs. |
| **PMI Mindset** | Consider the "big picture" of organizational resources. Avoid creating a crisis on one project to save a small amount on another. |
| **The Trap** | Focusing only on the $10,000 savings (Distractor 1) is a narrow view that ignores the $200,000 risk. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Math check: 
A: (80*0.5) + (90*0.3) + (70*0.2) = 40 + 27 + 14 = 81
B: (95*0.5) + (60*0.3) + (85*0.2) = 47.5 + 18 + 17 = 82.5
C: (70*0.5) + (100*0.3) + (80*0.2) = 35 + 30 + 16 = 81 |
| **PMI Mindset** | Use objective data to make selection decisions. The weighted system ensures the "best value" wins, not just the "best tech" or "best price." |
| **The Trap** | Miscalculating the weights or assuming the lowest price (Vendor C) or highest tech (Vendor B) wins without doing the math. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | T&M is perfect for urgent work with uncertain duration. Adding an NTE ceiling protects the buyer from runaway costs, providing a safety net while maintaining flexibility. |
| **PMI Mindset** | Balance the need for speed and flexibility with financial control. Ceilings are the primary risk control for T&M contracts. |
| **The Trap** | Using FFP (Distractor 1) for an emergency with unknown duration often leads to the consultant refusing to finish if the work exceeds the estimate. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When a contract violation is found, the PM must document it formally (NCR) and verify the impact on quality. You cannot ignore a breach, but termination is a last resort after investigation. |
| **PMI Mindset** | Control Procurements involves verifying compliance with all contract terms, not just the final output. Document deviations and require the vendor to prove compliance. |
| **The Trap** | Ignoring the breach (Distractor 2) because the final product "looks okay" is a failure of quality and procurement governance. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Deliverables are accepted based on the "Acceptance Criteria" defined in the contract at the time of signing. You cannot hold a vendor accountable for requirements that weren't in the agreement. |
| **PMI Mindset** | Fairness in procurement: The vendor is responsible for the SOW. New requirements (like branding updates) require the change control process. |
| **The Trap** | Rejecting the deliverable (Distractor 1) is a common reactive mistake that leads to disputes because the vendor actually fulfilled their legal obligation. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Professional integrity and legal compliance are non-negotiable. Bribery or requests to circumvent audits are major ethical breaches that must be reported. |
| **PMI Mindset** | Responsibility and Honesty: PMs must uphold the law and organizational policies. Never trade compliance for cost savings. |
| **The Trap** | Trying to "get the discount" while "staying safe" (Distractor 1) is still participating in an unethical and likely illegal negotiation. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | "Interest-based negotiation" looks for solutions that satisfy the underlying needs of both parties. Recovering the schedule helps the PM; providing labor instead of cash might be more acceptable to the vendor. |
| **PMI Mindset** | Move beyond "positions" to "interests." Win-win solutions are found by addressing what each party actually cares about. |
| **The Trap** | Focusing only on the "position" (Distractor 1 - pay the penalty) leads to a win-lose confrontation that might not even solve the schedule problem. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | ADR is the preferred path because it is faster, cheaper, and often keeps the relationship intact compared to the adversarial nature of a courtroom. |
| **PMI Mindset** | Look for efficient ways to resolve claims and disputes. ADR is a central concept in "Control Procurements." |
| **The Trap** | Litigation (Distractor 1) is almost always the "last resort" in PMP questions. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | FP-EPA is designed for exactly this: protecting both parties from external economic factors like currency fluctuations that neither party can control. |
| **PMI Mindset** | Manage risk through the contract structure. Fairness ensures the vendor remains viable throughout the long-term agreement. |
| **The Trap** | Forcing the vendor to take all the risk (Distractor 1) often leads to them going out of business or defaulting if the currency crashes. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | For service-based delivery (like SaaS), the SLA is the critical document that defines performance standards (uptime, response time) and penalties for failure. |
| **PMI Mindset** | Match the document to the delivery model. Services are governed by SLAs; physical products are governed by SOWs and specs. |
| **The Trap** | While a SOW is used, the SLA is the "teeth" of a service contract that defines how performance is actually measured. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | RFIs are specifically designed for market research when the buyer needs to understand what is available and "how" the market can solve a problem before committing to a purchase. |
| **PMI Mindset** | Use the right document for the phase. Research (RFI) precedes price-finding (RFQ/RFP). |
| **The Trap** | A bidder conference (Distractor 3) is used after the RFP is released to clarify it, not to help write it. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | CPAF uses an "Award Fee" which is determined subjectively by the buyer (often through an award board). This is perfect for goals like "innovation" or "satisfaction" that are hard to measure with objective math. |
| **PMI Mindset** | Use Award Fees for subjective excellence and Incentive Fees for objective targets (cost, schedule). |
| **The Trap** | CPIF (Distractor 1) uses a formula for incentive calculation, which is objective and auditable, not subjective. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Warranties protect the buyer from defects that are not immediately apparent (latent defects). Even if a deliverable is "accepted," the vendor may still be legally liable for the quality of their work for a set period. |
| **PMI Mindset** | Use the contract's protective clauses to manage long-term vendor accountability. Acceptance does not mean the vendor's liability for quality ends. |
| **The Trap** | Blaming the PO (Distractor 3) or paying again (Distractor 1) ignores the contractual protections that should already be in place. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Conditional acceptance (with a punch list) allows the project to move forward while maintaining financial leverage (retainage) to ensure the vendor completes the minor remaining items. |
| **PMI Mindset** | Be pragmatic but professional. Use retainage and punch lists to manage final closure without stopping the project for trivial issues. |
| **The Trap** | Total rejection (Distractor 1) is a disproportionate response to minor defects and would cause unnecessary business disruption. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Cultural awareness is a key part of negotiation. Ignoring cultural norms often leads to a "Lose-Lose" outcome or a complete breakdown in trust, which can cause even more delays. |
| **PMI Mindset** | Be culturally sensitive. Adapting your style to the other party's norms often leads to a faster and more sustainable agreement in the long run. |
| **The Trap** | Using threats (Distractor 3) or "forcing" (Distractor 1) with a relationship-based culture is the fastest way to kill the deal. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Procurement closure is not just about the final check. It's about archiving records, resolving outstanding claims, and conducting an audit/lessons learned session. |
| **PMI Mindset** | Close the loop. Administrative closure includes capturing the vendor's performance for future project managers to use. |
| **The Trap** | Deleting records (Distractor 2) is a massive compliance and legal risk. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | To make a strategy real, it must be part of the selection math. Including sustainability in the weighted scoring ensures it actually influences the choice of vendor. |
| **PMI Mindset** | Align procurement with organizational policy through formal selection criteria. |
| **The Trap** | Verbal confirmation (Distractor 1) is not auditable or objective and fails to fulfill the governance requirement. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | Regulatory and legal constraints (compliance) are "non-negotiable" and always trump cost or speed. If a solution isn't legal, it's not a viable solution. |
| **PMI Mindset** | Compliance and Ethics first. Always identify the mandatory constraints before evaluating technical or financial benefits. |
| **The Trap** | Cost and speed (Distractors 1 & 2) are important but secondary to the threshold of legality. |
| **Source Link** | `guide/06-project-planning/resource-planning.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | When a relationship breaks down, return to the facts and the formal structure of the contract. A structured review with higher-level management is a standard escalation step to resolve disputes. |
| **PMI Mindset** | Professionalism and conflict resolution: Address issues directly through established channels. Use the contract and documentation as your primary tools. |
| **The Trap** | Firing the vendor (Distractor 1) in the middle of a delay often makes the project even later and leads to a lawsuit. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Aspect | Details |
| :--- | :--- |
| **Core Logic** | In an Agile/Hybrid context, when budget is tight, you maximize value. The PM and PO must work together to identify which remaining work provides the most "bang for the buck" within the fixed financial constraint. |
| **PMI Mindset** | Focus on value delivery. If you can't have everything, make sure you get the most important things. |
| **The Trap** | Demanding free work (Distractor 1) is rarely successful and often leads to the vendor stopping work entirely once the ceiling is reached. |
| **Source Link** | `guide/08-execution/engagement-procurement.md` |
...
| Question | Enabler | Methodology | Difficulty |
| :--- | :--- | :--- | :--- |
| 1-5 | Contract Types, Suppliers, Execution, Strategy, Performance | Pred, Agile, Hybrid, Pred, Agile | 4/5 |
| 6-10 | Plan Proc, Negotiation, Verification, Contracts, Delivery | Hybrid, Pred, Agile, Pred, Hybrid | 4/5 |
| 11-15 | Plan Proc, Execution, Contract Types, Performance, Verification | Pred, Hybrid, Pred, Agile, Hybrid | 5/5 |
| 16-20 | Negotiations, Strategy, Suppliers, Plan Strategy, Delivery | Pred, Hybrid, Pred, Hybrid, Agile | 4/5 |
| 21-25 | Plan Proc, Execution, Contract Types, Performance, Verification | Pred, Hybrid, Pred, Agile, Hybrid | 4/5 |
| 26-30 | Negotiations, Strategy, Suppliers, Plan Strategy, Delivery | Pred, Hybrid, Agile, Pred, Hybrid | 5/5 |
| 31-35 | Plan Proc, Execution, Contract Types, Performance, Verification | Pred, Hybrid, Hybrid, Pred, Hybrid | 4/5 |
| 36-40 | Negotiations, Strategy, Suppliers, Plan Strategy, Delivery | Pred, Hybrid, Pred, Hybrid, Agile | 4/5 |
| 41-45 | Plan Strategy, Contract Types, Performance, Verification, Negotiations | Pred, Hybrid, Agile, Pred, Hybrid | 4/5 |
| 46-50 | Suppliers, Plan Strategy, Delivery, Suppliers, Execution | Agile, Hybrid, Pred, Pred, Agile | 5/5 |
...
| :--- | :--- |
| **Total Questions** | 50 |
| **Correct Answer Length Avg** | 12 words |
| **Distractor Length Avg** | 11 words |
