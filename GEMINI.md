...
- **2026-01-06**: Replaced unreadable code block for "Step-by-Step CPM Example" in `guide/06-project-planning/schedule-planning.md` with a visual `ConceptCard` diagram to clearly illustrate the critical path network logic.
