...
- **2026-01-14**: Added audio player to `guide/01-introduction/index.md` allowing users to listen to chapter narration. The audio file is located at `audio/Chapter 1/01-introduction.wav`. Player features styled container with headphone emoji label and HTML5 audio controls.
