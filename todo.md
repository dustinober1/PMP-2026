...
- [x] **Align exam specs to the July 2026 ECO** (185 questions, 240 minutes, two 5-minute breaks) and remove legacy “180 questions / 230 minutes / 10-minute breaks” references:
  - [x] `Chapter 10 - Exam Preparation and Future Trends/10.1 – Exam Strategy and Test-Taking Skills.md` (e.g., lines 11, 177-186, 240-254)
  - [x] `Chapter 10 - Exam Preparation and Future Trends/10.3a – Practice Exam 1.md:7`
  - [x] `Chapter 10 - Exam Preparation and Future Trends/10.3c – Practice Exam 2.md:11`
  - [x] `Chapter 10 - Exam Preparation and Future Trends/10.3e – Practice Exam 3.md:11`
  - [x] `Chapter 10 - Exam Preparation and Future Trends/10.3i – Exam Scoring Template.md:37` (and any other “Target: 230 minutes” lines)
  - [x] `Appendices/Progress-Tracking-Template.md:208`
...
- [x] **Fix broken cross-references to non-existent “Chapter 98/15/18/23/…” paths** (update to real files/anchors or remove until those chapters exist):
  - [x] `Chapter 01 - Introduction and Fundamentals/01.4a – Stakeholders and Communication.md:7` and `:42` reference `../Chapter 98/...`
  - [x] `Appendices/Appendix A.2 – The Planning Process Group.md:132` and `:196` reference `../Chapter 98/...`
  - [x] `Appendices/Appendix A.6 – Knowledge Check.md:49` and `:50` reference non-existent chapters
  - [x] `Appendices/Appendix B – Key Formulas and Definitions.md` contains multiple links to non-existent chapters (e.g., Chapter 4/10a/15/18)
  - [x] `Appendices/Appendix D – Tools and Artifacts Index.md` contains many links to non-existent chapters (broken-link heavy; decide whether to update now or exclude from first release)
  - [x] `Appendices/Concept-Map.md` contains many links to non-existent chapters (broken-link heavy; decide whether to update now or exclude from first release)
...
- [x] **Fix malformed Markdown links that use angle brackets in the link target** (these render as broken links in most Markdown parsers):
  - [x] `Chapter 10 - Exam Preparation and Future Trends/10.3c – Practice Exam 2.md:1550`
  - [x] `Chapter 10 - Exam Preparation and Future Trends/10.3d – Practice Exam 2 Answers.md:874`
  - [x] `Chapter 10 - Exam Preparation and Future Trends/10.3e – Practice Exam 3.md:1550` and `:1562`
  - [x] `Chapter 10 - Exam Preparation and Future Trends/10.3f – Practice Exam 3 Answers.md:987`
